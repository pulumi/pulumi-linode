...
public final class InstanceConfigDevicesSdalArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdalArgs Empty = new InstanceConfigDevicesSdalArgs();
    ...
    private InstanceConfigDevicesSdalArgs() {}

    private InstanceConfigDevicesSdalArgs(InstanceConfigDevicesSdalArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdalArgs();
        }

        public Builder(InstanceConfigDevicesSdalArgs defaults) {
            $ = new InstanceConfigDevicesSdalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdalArgs build() {
            return $;
        }
    }
