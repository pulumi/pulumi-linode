...
public final class GetLocksArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocksArgs Empty = new GetLocksArgs();

    @Import(name="filters")
    private @Nullable Output<List<GetLocksFilterArgs>> filters;

    public Optional<Output<List<GetLocksFilterArgs>>> filters() {
    ...
    private GetLocksArgs() {}

    private GetLocksArgs(GetLocksArgs $) {
    ...
    public static Builder builder(GetLocksArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetLocksArgs defaults) {
            $ = new GetLocksArgs(Objects.requireNonNull(defaults));
        }

        public Builder filters(@Nullable Output<List<GetLocksFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetLocksFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetLocksFilterArgs... filters) {
