...
@CustomType
public final class InstanceConfigDevicesSdbh {
    /**
    ...
    private InstanceConfigDevicesSdbh() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbh defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbh defaults) {
        ...
        public InstanceConfigDevicesSdbh build() {
            final var _resultValue = new InstanceConfigDevicesSdbh();
