...
@CustomType
public final class GetInstancesInstanceConfigDeviceSdah {
    /**
    ...
    private GetInstancesInstanceConfigDeviceSdah() {}
    /**
     * @return The Disk ID of the associated `diskLabel`, if used
     * 
     */
    ...
    public static Builder builder(GetInstancesInstanceConfigDeviceSdah defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(GetInstancesInstanceConfigDeviceSdah defaults) {
        ...
        public Builder diskId(Integer diskId) {
            if (diskId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceConfigDeviceSdah", "diskId");
            }
            this.diskId = diskId;
            return this;
        }
        ...
        public GetInstancesInstanceConfigDeviceSdah build() {
            final var _resultValue = new GetInstancesInstanceConfigDeviceSdah();
