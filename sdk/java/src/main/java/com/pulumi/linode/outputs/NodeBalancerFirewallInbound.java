...
@CustomType
public final class NodeBalancerFirewallInbound {
    /**
    ...
    public static Builder builder(NodeBalancerFirewallInbound defaults) {
    ...
    public static final class Builder {
        ...
        private String protocol;
        public Builder() {}
        public Builder(NodeBalancerFirewallInbound defaults) {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "description");
            }
        ...
        public Builder ipv4s(List<String> ipv4s) {
            if (ipv4s == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "ipv4s");
            }
            this.ipv4s = ipv4s;
            return this;
        }
        ...
        public Builder ipv6s(List<String> ipv6s) {
            if (ipv6s == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "ipv6s");
            }
            this.ipv6s = ipv6s;
            return this;
        }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder ports(String ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("NodeBalancerFirewallInbound", "protocol");
            }
            this.protocol = protocol;
            return this;
        }
        public NodeBalancerFirewallInbound build() {
            final var _resultValue = new NodeBalancerFirewallInbound();
