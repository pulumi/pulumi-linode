...
public final class InstanceConfigDevicesSdavArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdavArgs Empty = new InstanceConfigDevicesSdavArgs();
    ...
    private InstanceConfigDevicesSdavArgs() {}

    private InstanceConfigDevicesSdavArgs(InstanceConfigDevicesSdavArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdavArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdavArgs();
        }

        public Builder(InstanceConfigDevicesSdavArgs defaults) {
            $ = new InstanceConfigDevicesSdavArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdavArgs build() {
            return $;
        }
    }
