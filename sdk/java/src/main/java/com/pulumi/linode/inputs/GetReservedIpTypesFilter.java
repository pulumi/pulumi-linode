...
public final class GetReservedIpTypesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetReservedIpTypesFilter Empty = new GetReservedIpTypesFilter();
    ...
    private GetReservedIpTypesFilter() {}

    private GetReservedIpTypesFilter(GetReservedIpTypesFilter $) {
    ...
    public static Builder builder(GetReservedIpTypesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReservedIpTypesFilter();
        }

        public Builder(GetReservedIpTypesFilter defaults) {
            $ = new GetReservedIpTypesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetReservedIpTypesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetReservedIpTypesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetReservedIpTypesFilter", "values");
            }
            return $;
        }
    }
