...
@CustomType
public final class GetInstancesInstanceConfigDeviceSde {
    /**
    ...
    private GetInstancesInstanceConfigDeviceSde() {}
    /**
     * @return The Disk ID of the associated `disk_label`, if used
     * 
     */
    ...
    public static Builder builder(GetInstancesInstanceConfigDeviceSde defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(GetInstancesInstanceConfigDeviceSde defaults) {
        ...
        public Builder diskId(Integer diskId) {
            if (diskId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceConfigDeviceSde", "diskId");
            }
            this.diskId = diskId;
            return this;
        }
        ...
        public GetInstancesInstanceConfigDeviceSde build() {
            final var _resultValue = new GetInstancesInstanceConfigDeviceSde();
