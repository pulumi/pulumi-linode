...
@CustomType
public final class InstanceConfigDevicesSdba {
    /**
    ...
    private InstanceConfigDevicesSdba() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdba defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdba defaults) {
        ...
        public InstanceConfigDevicesSdba build() {
            final var _resultValue = new InstanceConfigDevicesSdba();
