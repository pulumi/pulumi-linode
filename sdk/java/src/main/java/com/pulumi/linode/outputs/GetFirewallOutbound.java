...
@CustomType
public final class GetFirewallOutbound {
    /**
    ...
    public static final class Builder {
        ...
        public Builder ipv4s(List<String> ipv4s) {
            if (ipv4s == null) {
              throw new MissingRequiredPropertyException("GetFirewallOutbound", "ipv4s");
            }
            this.ipv4s = ipv4s;
            return this;
        }
        ...
        public Builder ipv6s(List<String> ipv6s) {
            if (ipv6s == null) {
              throw new MissingRequiredPropertyException("GetFirewallOutbound", "ipv6s");
            }
            this.ipv6s = ipv6s;
            return this;
        }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetFirewallOutbound", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder ports(String ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetFirewallOutbound", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetFirewallOutbound", "protocol");
            }
