...
public final class DatabasePostgresqlV2Updates {
    ...
    public static Builder builder(DatabasePostgresqlV2Updates defaults) {
    ...
    public static final class Builder {
        ...
        public DatabasePostgresqlV2Updates build() {
            final var _resultValue = new DatabasePostgresqlV2Updates();
