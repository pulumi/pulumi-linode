...
public final class InstanceConfigDevicesSdkArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdkArgs Empty = new InstanceConfigDevicesSdkArgs();
    ...
    private InstanceConfigDevicesSdkArgs() {}

    private InstanceConfigDevicesSdkArgs(InstanceConfigDevicesSdkArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdkArgs();
        }

        public Builder(InstanceConfigDevicesSdkArgs defaults) {
            $ = new InstanceConfigDevicesSdkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdkArgs build() {
            return $;
        }
    }
