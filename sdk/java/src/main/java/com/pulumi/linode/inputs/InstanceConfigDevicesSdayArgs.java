...
public final class InstanceConfigDevicesSdayArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdayArgs Empty = new InstanceConfigDevicesSdayArgs();
    ...
    private InstanceConfigDevicesSdayArgs() {}

    private InstanceConfigDevicesSdayArgs(InstanceConfigDevicesSdayArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdayArgs();
        }

        public Builder(InstanceConfigDevicesSdayArgs defaults) {
            $ = new InstanceConfigDevicesSdayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdayArgs build() {
            return $;
        }
    }
