...
public final class InstanceConfigDevicesSdnArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdnArgs Empty = new InstanceConfigDevicesSdnArgs();
    ...
    private InstanceConfigDevicesSdnArgs() {}

    private InstanceConfigDevicesSdnArgs(InstanceConfigDevicesSdnArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdnArgs();
        }

        public Builder(InstanceConfigDevicesSdnArgs defaults) {
            $ = new InstanceConfigDevicesSdnArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdnArgs build() {
            return $;
        }
    }
