...
public final class GetMonitorLogsStreamsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetMonitorLogsStreamsFilter Empty = new GetMonitorLogsStreamsFilter();
    ...
    private GetMonitorLogsStreamsFilter() {}

    private GetMonitorLogsStreamsFilter(GetMonitorLogsStreamsFilter $) {
    ...
    public static Builder builder(GetMonitorLogsStreamsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMonitorLogsStreamsFilter();
        }

        public Builder(GetMonitorLogsStreamsFilter defaults) {
            $ = new GetMonitorLogsStreamsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetMonitorLogsStreamsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMonitorLogsStreamsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMonitorLogsStreamsFilter", "values");
            }
            return $;
        }
    }
