...
public final class InstanceConfigDevicesSdapArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdapArgs Empty = new InstanceConfigDevicesSdapArgs();
    ...
    private InstanceConfigDevicesSdapArgs() {}

    private InstanceConfigDevicesSdapArgs(InstanceConfigDevicesSdapArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdapArgs();
        }

        public Builder(InstanceConfigDevicesSdapArgs defaults) {
            $ = new InstanceConfigDevicesSdapArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdapArgs build() {
            return $;
        }
    }
