...
@CustomType
public final class InstanceConfigDevicesSdi {
    /**
    ...
    private InstanceConfigDevicesSdi() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdi defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdi defaults) {
        ...
        public InstanceConfigDevicesSdi build() {
            final var _resultValue = new InstanceConfigDevicesSdi();
