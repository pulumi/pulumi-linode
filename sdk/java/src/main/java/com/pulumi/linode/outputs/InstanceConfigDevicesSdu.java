...
@CustomType
public final class InstanceConfigDevicesSdu {
    /**
    ...
    private InstanceConfigDevicesSdu() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdu defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdu defaults) {
        ...
        public InstanceConfigDevicesSdu build() {
            final var _resultValue = new InstanceConfigDevicesSdu();
