...
@CustomType
public final class InstanceConfigDevicesSdbc {
    /**
    ...
    private InstanceConfigDevicesSdbc() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbc defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbc defaults) {
        ...
        public InstanceConfigDevicesSdbc build() {
            final var _resultValue = new InstanceConfigDevicesSdbc();
