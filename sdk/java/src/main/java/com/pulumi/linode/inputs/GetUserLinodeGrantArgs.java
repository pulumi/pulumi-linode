...
public final class GetUserLinodeGrantArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetUserLinodeGrantArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserLinodeGrantArgs", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserLinodeGrantArgs", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserLinodeGrantArgs", "permissions");
            }
            return $;
        }
    }
