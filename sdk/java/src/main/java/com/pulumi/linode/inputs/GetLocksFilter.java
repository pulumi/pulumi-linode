...
public final class GetLocksFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetLocksFilter Empty = new GetLocksFilter();
    ...
    private GetLocksFilter() {}

    private GetLocksFilter(GetLocksFilter $) {
    ...
    public static Builder builder(GetLocksFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetLocksFilter defaults) {
            $ = new GetLocksFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocksFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLocksFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLocksFilter", "values");
            }
            return $;
        }
    }
