...
@CustomType
public final class InstanceConfigDevicesSdh {
    /**
    ...
    public static Builder builder(InstanceConfigDevicesSdh defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InstanceConfigDevicesSdh defaults) {
        ...
        public Builder volumeId(@Nullable Integer volumeId) {
            this.volumeId = volumeId;
            return this;
        }        public InstanceConfigDevicesSdh build() {
            return new InstanceConfigDevicesSdh(diskId, diskLabel, volumeId);
        }
    }
}
