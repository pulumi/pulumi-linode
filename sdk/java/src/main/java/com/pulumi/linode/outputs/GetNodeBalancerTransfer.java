...
public final class GetNodeBalancerTransfer {
    ...
    public static final class Builder {
        ...
        public Builder in(Double in) {
            if (in == null) {
              throw new MissingRequiredPropertyException("GetNodeBalancerTransfer", "in");
            }
            this.in = in;
            return this;
        }
        ...
        public Builder out(Double out) {
            if (out == null) {
              throw new MissingRequiredPropertyException("GetNodeBalancerTransfer", "out");
            }
            this.out = out;
            return this;
        }
        ...
        public Builder total(Double total) {
            if (total == null) {
              throw new MissingRequiredPropertyException("GetNodeBalancerTransfer", "total");
            }
            this.total = total;
            return this;
        }
        public GetNodeBalancerTransfer build() {
            final var _resultValue = new GetNodeBalancerTransfer();
            _resultValue.in = in;
