...
@CustomType
public final class InstanceConfigDevicesSdaa {
    /**
    ...
    private InstanceConfigDevicesSdaa() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdaa defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdaa defaults) {
        ...
        public InstanceConfigDevicesSdaa build() {
            final var _resultValue = new InstanceConfigDevicesSdaa();
