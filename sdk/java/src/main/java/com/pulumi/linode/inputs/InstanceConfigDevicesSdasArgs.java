...
public final class InstanceConfigDevicesSdasArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdasArgs Empty = new InstanceConfigDevicesSdasArgs();
    ...
    private InstanceConfigDevicesSdasArgs() {}

    private InstanceConfigDevicesSdasArgs(InstanceConfigDevicesSdasArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdasArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdasArgs();
        }

        public Builder(InstanceConfigDevicesSdasArgs defaults) {
            $ = new InstanceConfigDevicesSdasArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdasArgs build() {
            return $;
        }
    }
