...
public final class GetUserStackscriptGrantArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetUserStackscriptGrantArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserStackscriptGrantArgs", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserStackscriptGrantArgs", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserStackscriptGrantArgs", "permissions");
            }
            return $;
        }
    }
