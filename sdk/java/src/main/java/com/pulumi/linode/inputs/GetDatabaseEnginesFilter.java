...
public final class GetDatabaseEnginesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetDatabaseEnginesFilter Empty = new GetDatabaseEnginesFilter();
    ...
    private GetDatabaseEnginesFilter() {}

    private GetDatabaseEnginesFilter(GetDatabaseEnginesFilter $) {
    ...
    public static Builder builder(GetDatabaseEnginesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDatabaseEnginesFilter();
        }

        public Builder(GetDatabaseEnginesFilter defaults) {
            $ = new GetDatabaseEnginesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetDatabaseEnginesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetDatabaseEnginesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetDatabaseEnginesFilter", "values");
            }
            return $;
        }
    }
