...
@CustomType
public final class InstanceConfigDevicesSdat {
    /**
    ...
    private InstanceConfigDevicesSdat() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdat defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdat defaults) {
        ...
        public InstanceConfigDevicesSdat build() {
            final var _resultValue = new InstanceConfigDevicesSdat();
