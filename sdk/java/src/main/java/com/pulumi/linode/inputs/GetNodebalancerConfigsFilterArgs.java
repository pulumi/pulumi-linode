...
public final class GetNodebalancerConfigsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNodebalancerConfigsFilterArgs Empty = new GetNodebalancerConfigsFilterArgs();
    ...
    private GetNodebalancerConfigsFilterArgs() {}

    private GetNodebalancerConfigsFilterArgs(GetNodebalancerConfigsFilterArgs $) {
    ...
    public static Builder builder(GetNodebalancerConfigsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancerConfigsFilterArgs();
        }

        public Builder(GetNodebalancerConfigsFilterArgs defaults) {
            $ = new GetNodebalancerConfigsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodebalancerConfigsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerConfigsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerConfigsFilterArgs", "values");
            }
            return $;
        }
    }
