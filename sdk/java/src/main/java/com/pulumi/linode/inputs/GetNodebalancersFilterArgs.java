...
public final class GetNodebalancersFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNodebalancersFilterArgs Empty = new GetNodebalancersFilterArgs();
    ...
    private GetNodebalancersFilterArgs() {}

    private GetNodebalancersFilterArgs(GetNodebalancersFilterArgs $) {
    ...
    public static Builder builder(GetNodebalancersFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancersFilterArgs();
        }

        public Builder(GetNodebalancersFilterArgs defaults) {
            $ = new GetNodebalancersFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodebalancersFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNodebalancersFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetNodebalancersFilterArgs", "values");
            }
            return $;
        }
    }
