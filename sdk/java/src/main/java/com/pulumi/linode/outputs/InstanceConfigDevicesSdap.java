...
@CustomType
public final class InstanceConfigDevicesSdap {
    /**
    ...
    private InstanceConfigDevicesSdap() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdap defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdap defaults) {
        ...
        public InstanceConfigDevicesSdap build() {
            final var _resultValue = new InstanceConfigDevicesSdap();
