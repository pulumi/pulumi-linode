...
public final class GetReservedIpTypesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetReservedIpTypesFilterArgs Empty = new GetReservedIpTypesFilterArgs();
    ...
    private GetReservedIpTypesFilterArgs() {}

    private GetReservedIpTypesFilterArgs(GetReservedIpTypesFilterArgs $) {
    ...
    public static Builder builder(GetReservedIpTypesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReservedIpTypesFilterArgs();
        }

        public Builder(GetReservedIpTypesFilterArgs defaults) {
            $ = new GetReservedIpTypesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetReservedIpTypesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetReservedIpTypesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetReservedIpTypesFilterArgs", "values");
            }
            return $;
        }
    }
