...
@CustomType
public final class InstanceConfigDevicesSdbe {
    /**
    ...
    private InstanceConfigDevicesSdbe() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbe defaults) {
        ...
        public InstanceConfigDevicesSdbe build() {
            final var _resultValue = new InstanceConfigDevicesSdbe();
