...
public final class GetUsersUserLinodeGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUsersUserLinodeGrant Empty = new GetUsersUserLinodeGrant();
    ...
    private GetUsersUserLinodeGrant() {}

    private GetUsersUserLinodeGrant(GetUsersUserLinodeGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static Builder builder(GetUsersUserLinodeGrant defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUsersUserLinodeGrant();
        }

        public Builder(GetUsersUserLinodeGrant defaults) {
            $ = new GetUsersUserLinodeGrant(Objects.requireNonNull(defaults));
        }
