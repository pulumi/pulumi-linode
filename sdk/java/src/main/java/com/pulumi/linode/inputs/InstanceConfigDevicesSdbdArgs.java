...
public final class InstanceConfigDevicesSdbdArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbdArgs Empty = new InstanceConfigDevicesSdbdArgs();
    ...
    private InstanceConfigDevicesSdbdArgs() {}

    private InstanceConfigDevicesSdbdArgs(InstanceConfigDevicesSdbdArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbdArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbdArgs();
        }

        public Builder(InstanceConfigDevicesSdbdArgs defaults) {
            $ = new InstanceConfigDevicesSdbdArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbdArgs build() {
            return $;
        }
    }
