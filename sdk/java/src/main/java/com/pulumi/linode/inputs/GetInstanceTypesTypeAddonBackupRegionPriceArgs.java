...
public final class GetInstanceTypesTypeAddonBackupRegionPriceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetInstanceTypesTypeAddonBackupRegionPriceArgs build() {
            if ($.hourly == null) {
                throw new MissingRequiredPropertyException("GetInstanceTypesTypeAddonBackupRegionPriceArgs", "hourly");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetInstanceTypesTypeAddonBackupRegionPriceArgs", "id");
            }
            if ($.monthly == null) {
                throw new MissingRequiredPropertyException("GetInstanceTypesTypeAddonBackupRegionPriceArgs", "monthly");
            }
            return $;
        }
    }
