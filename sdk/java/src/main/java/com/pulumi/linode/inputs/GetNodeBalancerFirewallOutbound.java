...
public final class GetNodeBalancerFirewallOutbound extends com.pulumi.resources.InvokeArgs {

    public static final GetNodeBalancerFirewallOutbound Empty = new GetNodeBalancerFirewallOutbound();
    ...
    private GetNodeBalancerFirewallOutbound(GetNodeBalancerFirewallOutbound $) {
        this.action = $.action;
        this.ipv4s = $.ipv4s;
        this.ipv6s = $.ipv6s;
        this.label = $.label;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodeBalancerFirewallOutbound();
        }

        public Builder(GetNodeBalancerFirewallOutbound defaults) {
            $ = new GetNodeBalancerFirewallOutbound(Objects.requireNonNull(defaults));
        }
