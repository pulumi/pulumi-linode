...
public final class InstanceConfigDevicesSdrArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdrArgs Empty = new InstanceConfigDevicesSdrArgs();
    ...
    private InstanceConfigDevicesSdrArgs() {}

    private InstanceConfigDevicesSdrArgs(InstanceConfigDevicesSdrArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdrArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdrArgs();
        }

        public Builder(InstanceConfigDevicesSdrArgs defaults) {
            $ = new InstanceConfigDevicesSdrArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdrArgs build() {
            return $;
        }
    }
