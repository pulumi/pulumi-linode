...
public final class GetNodeBalancerFirewallOutboundArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNodeBalancerFirewallOutboundArgs Empty = new GetNodeBalancerFirewallOutboundArgs();
    ...
    private GetNodeBalancerFirewallOutboundArgs() {}

    private GetNodeBalancerFirewallOutboundArgs(GetNodeBalancerFirewallOutboundArgs $) {
        this.action = $.action;
        this.ipv4s = $.ipv4s;
        this.ipv6s = $.ipv6s;
        this.label = $.label;
    ...
    public static Builder builder(GetNodeBalancerFirewallOutboundArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodeBalancerFirewallOutboundArgs();
        }

        public Builder(GetNodeBalancerFirewallOutboundArgs defaults) {
            $ = new GetNodeBalancerFirewallOutboundArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodeBalancerFirewallOutboundArgs build() {
            if ($.action == null) {
                throw new MissingRequiredPropertyException("GetNodeBalancerFirewallOutboundArgs", "action");
            }
            if ($.ipv4s == null) {
                throw new MissingRequiredPropertyException("GetNodeBalancerFirewallOutboundArgs", "ipv4s");
            }
            if ($.ipv6s == null) {
                throw new MissingRequiredPropertyException("GetNodeBalancerFirewallOutboundArgs", "ipv6s");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetNodeBalancerFirewallOutboundArgs", "label");
            }
            if ($.ports == null) {
                throw new MissingRequiredPropertyException("GetNodeBalancerFirewallOutboundArgs", "ports");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("GetNodeBalancerFirewallOutboundArgs", "protocol");
            }
            return $;
        }
    }
