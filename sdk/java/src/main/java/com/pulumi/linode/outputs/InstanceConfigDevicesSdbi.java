...
@CustomType
public final class InstanceConfigDevicesSdbi {
    /**
    ...
    private InstanceConfigDevicesSdbi() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbi defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbi defaults) {
        ...
        public InstanceConfigDevicesSdbi build() {
            final var _resultValue = new InstanceConfigDevicesSdbi();
