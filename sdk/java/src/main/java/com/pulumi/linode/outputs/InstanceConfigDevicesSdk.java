...
@CustomType
public final class InstanceConfigDevicesSdk {
    /**
    ...
    private InstanceConfigDevicesSdk() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdk defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdk defaults) {
        ...
        public InstanceConfigDevicesSdk build() {
            final var _resultValue = new InstanceConfigDevicesSdk();
