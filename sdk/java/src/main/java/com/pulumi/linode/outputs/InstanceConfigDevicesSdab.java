...
@CustomType
public final class InstanceConfigDevicesSdab {
    /**
    ...
    private InstanceConfigDevicesSdab() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdab defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdab defaults) {
        ...
        public InstanceConfigDevicesSdab build() {
            final var _resultValue = new InstanceConfigDevicesSdab();
