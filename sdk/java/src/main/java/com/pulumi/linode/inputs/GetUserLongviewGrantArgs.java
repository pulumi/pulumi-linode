...
public final class GetUserLongviewGrantArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetUserLongviewGrantArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserLongviewGrantArgs", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserLongviewGrantArgs", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserLongviewGrantArgs", "permissions");
            }
            return $;
        }
    }
