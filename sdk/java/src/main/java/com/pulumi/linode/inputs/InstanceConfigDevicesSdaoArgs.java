...
public final class InstanceConfigDevicesSdaoArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdaoArgs Empty = new InstanceConfigDevicesSdaoArgs();
    ...
    private InstanceConfigDevicesSdaoArgs() {}

    private InstanceConfigDevicesSdaoArgs(InstanceConfigDevicesSdaoArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdaoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdaoArgs();
        }

        public Builder(InstanceConfigDevicesSdaoArgs defaults) {
            $ = new InstanceConfigDevicesSdaoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdaoArgs build() {
            return $;
        }
    }
