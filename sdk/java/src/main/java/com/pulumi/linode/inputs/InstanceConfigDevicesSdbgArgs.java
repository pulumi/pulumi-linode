...
public final class InstanceConfigDevicesSdbgArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbgArgs Empty = new InstanceConfigDevicesSdbgArgs();
    ...
    private InstanceConfigDevicesSdbgArgs() {}

    private InstanceConfigDevicesSdbgArgs(InstanceConfigDevicesSdbgArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbgArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbgArgs();
        }

        public Builder(InstanceConfigDevicesSdbgArgs defaults) {
            $ = new InstanceConfigDevicesSdbgArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbgArgs build() {
            return $;
        }
    }
