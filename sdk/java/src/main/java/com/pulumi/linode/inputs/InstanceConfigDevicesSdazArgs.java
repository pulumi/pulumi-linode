...
public final class InstanceConfigDevicesSdazArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdazArgs Empty = new InstanceConfigDevicesSdazArgs();
    ...
    private InstanceConfigDevicesSdazArgs() {}

    private InstanceConfigDevicesSdazArgs(InstanceConfigDevicesSdazArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdazArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdazArgs();
        }

        public Builder(InstanceConfigDevicesSdazArgs defaults) {
            $ = new InstanceConfigDevicesSdazArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdazArgs build() {
            return $;
        }
    }
