...
public final class InstanceConfigDevicesSdatArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdatArgs Empty = new InstanceConfigDevicesSdatArgs();
    ...
    private InstanceConfigDevicesSdatArgs() {}

    private InstanceConfigDevicesSdatArgs(InstanceConfigDevicesSdatArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdatArgs();
        }

        public Builder(InstanceConfigDevicesSdatArgs defaults) {
            $ = new InstanceConfigDevicesSdatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdatArgs build() {
            return $;
        }
    }
