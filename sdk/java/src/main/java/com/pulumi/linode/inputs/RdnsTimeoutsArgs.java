...
public final class RdnsTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RdnsTimeoutsArgs Empty = new RdnsTimeoutsArgs();
    ...
    private RdnsTimeoutsArgs() {}

    private RdnsTimeoutsArgs(RdnsTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(RdnsTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RdnsTimeoutsArgs();
        }

        public Builder(RdnsTimeoutsArgs defaults) {
            $ = new RdnsTimeoutsArgs(Objects.requireNonNull(defaults));
        }
