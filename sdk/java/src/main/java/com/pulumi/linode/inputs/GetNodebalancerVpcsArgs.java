...
public final class GetNodebalancerVpcsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNodebalancerVpcsArgs Empty = new GetNodebalancerVpcsArgs();

    @Import(name="filters")
    private @Nullable Output<List<GetNodebalancerVpcsFilterArgs>> filters;

    public Optional<Output<List<GetNodebalancerVpcsFilterArgs>>> filters() {
    ...
    private GetNodebalancerVpcsArgs() {}

    private GetNodebalancerVpcsArgs(GetNodebalancerVpcsArgs $) {
    ...
    public static Builder builder(GetNodebalancerVpcsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancerVpcsArgs();
        }

        public Builder(GetNodebalancerVpcsArgs defaults) {
            $ = new GetNodebalancerVpcsArgs(Objects.requireNonNull(defaults));
        }

        public Builder filters(@Nullable Output<List<GetNodebalancerVpcsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetNodebalancerVpcsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetNodebalancerVpcsFilterArgs... filters) {
        ...
        public GetNodebalancerVpcsArgs build() {
            if ($.nodebalancerId == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerVpcsArgs", "nodebalancerId");
            }
            return $;
        }
    }
