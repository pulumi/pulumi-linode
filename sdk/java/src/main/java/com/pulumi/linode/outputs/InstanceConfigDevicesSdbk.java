...
@CustomType
public final class InstanceConfigDevicesSdbk {
    /**
    ...
    private InstanceConfigDevicesSdbk() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbk defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbk defaults) {
        ...
        public InstanceConfigDevicesSdbk build() {
            final var _resultValue = new InstanceConfigDevicesSdbk();
