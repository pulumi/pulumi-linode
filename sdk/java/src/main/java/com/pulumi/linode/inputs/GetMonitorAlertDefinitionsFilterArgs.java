...
public final class GetMonitorAlertDefinitionsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMonitorAlertDefinitionsFilterArgs Empty = new GetMonitorAlertDefinitionsFilterArgs();
    ...
    private GetMonitorAlertDefinitionsFilterArgs() {}

    private GetMonitorAlertDefinitionsFilterArgs(GetMonitorAlertDefinitionsFilterArgs $) {
    ...
    public static Builder builder(GetMonitorAlertDefinitionsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMonitorAlertDefinitionsFilterArgs();
        }

        public Builder(GetMonitorAlertDefinitionsFilterArgs defaults) {
            $ = new GetMonitorAlertDefinitionsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMonitorAlertDefinitionsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMonitorAlertDefinitionsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMonitorAlertDefinitionsFilterArgs", "values");
            }
            return $;
        }
    }
