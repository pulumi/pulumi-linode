...
@CustomType
public final class InstanceConfigDevicesSdav {
    /**
    ...
    private InstanceConfigDevicesSdav() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdav defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdav defaults) {
        ...
        public InstanceConfigDevicesSdav build() {
            final var _resultValue = new InstanceConfigDevicesSdav();
