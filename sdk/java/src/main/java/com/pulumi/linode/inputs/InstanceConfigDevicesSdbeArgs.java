...
public final class InstanceConfigDevicesSdbeArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbeArgs Empty = new InstanceConfigDevicesSdbeArgs();
    ...
    private InstanceConfigDevicesSdbeArgs() {}

    private InstanceConfigDevicesSdbeArgs(InstanceConfigDevicesSdbeArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbeArgs();
        }

        public Builder(InstanceConfigDevicesSdbeArgs defaults) {
            $ = new InstanceConfigDevicesSdbeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbeArgs build() {
            return $;
        }
    }
