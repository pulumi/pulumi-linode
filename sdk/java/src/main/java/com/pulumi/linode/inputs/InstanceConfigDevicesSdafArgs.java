...
public final class InstanceConfigDevicesSdafArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdafArgs Empty = new InstanceConfigDevicesSdafArgs();
    ...
    private InstanceConfigDevicesSdafArgs() {}

    private InstanceConfigDevicesSdafArgs(InstanceConfigDevicesSdafArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdafArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdafArgs();
        }

        public Builder(InstanceConfigDevicesSdafArgs defaults) {
            $ = new InstanceConfigDevicesSdafArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdafArgs build() {
            return $;
        }
    }
