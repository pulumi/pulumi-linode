...
@CustomType
public final class InstanceConfigDevicesSdbg {
    /**
    ...
    private InstanceConfigDevicesSdbg() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbg defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbg defaults) {
        ...
        public InstanceConfigDevicesSdbg build() {
            final var _resultValue = new InstanceConfigDevicesSdbg();
