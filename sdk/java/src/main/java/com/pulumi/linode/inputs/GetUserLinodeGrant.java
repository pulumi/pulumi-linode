...
public final class GetUserLinodeGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUserLinodeGrant Empty = new GetUserLinodeGrant();
    ...
    private GetUserLinodeGrant(GetUserLinodeGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUserLinodeGrant();
        }

        public Builder(GetUserLinodeGrant defaults) {
            $ = new GetUserLinodeGrant(Objects.requireNonNull(defaults));
        }
