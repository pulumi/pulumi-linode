...
public final class GetProducerImageShareGroupsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetProducerImageShareGroupsFilterArgs Empty = new GetProducerImageShareGroupsFilterArgs();
    ...
    private GetProducerImageShareGroupsFilterArgs() {}

    private GetProducerImageShareGroupsFilterArgs(GetProducerImageShareGroupsFilterArgs $) {
    ...
    public static Builder builder(GetProducerImageShareGroupsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProducerImageShareGroupsFilterArgs();
        }

        public Builder(GetProducerImageShareGroupsFilterArgs defaults) {
            $ = new GetProducerImageShareGroupsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetProducerImageShareGroupsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetProducerImageShareGroupsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetProducerImageShareGroupsFilterArgs", "values");
            }
            return $;
        }
    }
