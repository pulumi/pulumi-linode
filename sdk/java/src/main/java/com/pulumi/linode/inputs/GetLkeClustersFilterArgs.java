...
public final class GetLkeClustersFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetLkeClustersFilterArgs Empty = new GetLkeClustersFilterArgs();
    ...
    private GetLkeClustersFilterArgs() {}

    private GetLkeClustersFilterArgs(GetLkeClustersFilterArgs $) {
    ...
    public static Builder builder(GetLkeClustersFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLkeClustersFilterArgs();
        }

        public Builder(GetLkeClustersFilterArgs defaults) {
            $ = new GetLkeClustersFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLkeClustersFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLkeClustersFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLkeClustersFilterArgs", "values");
            }
            return $;
        }
    }
