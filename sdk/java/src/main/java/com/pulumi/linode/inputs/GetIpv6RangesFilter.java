...
public final class GetIpv6RangesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetIpv6RangesFilter Empty = new GetIpv6RangesFilter();
    ...
    private GetIpv6RangesFilter() {}

    private GetIpv6RangesFilter(GetIpv6RangesFilter $) {
    ...
    public static Builder builder(GetIpv6RangesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIpv6RangesFilter();
        }

        public Builder(GetIpv6RangesFilter defaults) {
            $ = new GetIpv6RangesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetIpv6RangesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetIpv6RangesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetIpv6RangesFilter", "values");
            }
            return $;
        }
    }
