...
public final class GetVpcIpsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetVpcIpsFilterArgs Empty = new GetVpcIpsFilterArgs();
    ...
    private GetVpcIpsFilterArgs() {}

    private GetVpcIpsFilterArgs(GetVpcIpsFilterArgs $) {
    ...
    public static Builder builder(GetVpcIpsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpcIpsFilterArgs();
        }

        public Builder(GetVpcIpsFilterArgs defaults) {
            $ = new GetVpcIpsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVpcIpsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVpcIpsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVpcIpsFilterArgs", "values");
            }
            return $;
        }
    }
