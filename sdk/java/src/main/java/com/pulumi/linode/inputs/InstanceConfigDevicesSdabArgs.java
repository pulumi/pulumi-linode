...
public final class InstanceConfigDevicesSdabArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdabArgs Empty = new InstanceConfigDevicesSdabArgs();
    ...
    private InstanceConfigDevicesSdabArgs() {}

    private InstanceConfigDevicesSdabArgs(InstanceConfigDevicesSdabArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdabArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdabArgs();
        }

        public Builder(InstanceConfigDevicesSdabArgs defaults) {
            $ = new InstanceConfigDevicesSdabArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdabArgs build() {
            return $;
        }
    }
