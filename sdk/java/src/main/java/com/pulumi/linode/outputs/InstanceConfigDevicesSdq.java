...
@CustomType
public final class InstanceConfigDevicesSdq {
    /**
    ...
    private InstanceConfigDevicesSdq() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdq defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdq defaults) {
        ...
        public InstanceConfigDevicesSdq build() {
            final var _resultValue = new InstanceConfigDevicesSdq();
