...
public final class InstanceConfigDevicesSdbiArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbiArgs Empty = new InstanceConfigDevicesSdbiArgs();
    ...
    private InstanceConfigDevicesSdbiArgs() {}

    private InstanceConfigDevicesSdbiArgs(InstanceConfigDevicesSdbiArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbiArgs();
        }

        public Builder(InstanceConfigDevicesSdbiArgs defaults) {
            $ = new InstanceConfigDevicesSdbiArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbiArgs build() {
            return $;
        }
    }
