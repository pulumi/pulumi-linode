...
public final class GetUsersUserDatabaseGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUsersUserDatabaseGrant Empty = new GetUsersUserDatabaseGrant();
    ...
    private GetUsersUserDatabaseGrant(GetUsersUserDatabaseGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUsersUserDatabaseGrant();
        }

        public Builder(GetUsersUserDatabaseGrant defaults) {
            $ = new GetUsersUserDatabaseGrant(Objects.requireNonNull(defaults));
        }
        ...
        public GetUsersUserDatabaseGrant build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUsersUserDatabaseGrant", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUsersUserDatabaseGrant", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUsersUserDatabaseGrant", "permissions");
            }
            return $;
        }
    }
