...
@CustomType
public final class GetInstancesInstanceConfigDeviceSdbi {
    /**
    ...
    private GetInstancesInstanceConfigDeviceSdbi() {}
    /**
     * @return The Disk ID of the associated `diskLabel`, if used
     * 
     */
    ...
    public static Builder builder(GetInstancesInstanceConfigDeviceSdbi defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(GetInstancesInstanceConfigDeviceSdbi defaults) {
        ...
        public Builder diskId(Integer diskId) {
            if (diskId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceConfigDeviceSdbi", "diskId");
            }
            this.diskId = diskId;
            return this;
        }
        ...
        public GetInstancesInstanceConfigDeviceSdbi build() {
            final var _resultValue = new GetInstancesInstanceConfigDeviceSdbi();
