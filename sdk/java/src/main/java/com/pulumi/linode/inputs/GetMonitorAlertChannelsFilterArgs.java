...
public final class GetMonitorAlertChannelsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMonitorAlertChannelsFilterArgs Empty = new GetMonitorAlertChannelsFilterArgs();
    ...
    private GetMonitorAlertChannelsFilterArgs() {}

    private GetMonitorAlertChannelsFilterArgs(GetMonitorAlertChannelsFilterArgs $) {
    ...
    public static Builder builder(GetMonitorAlertChannelsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMonitorAlertChannelsFilterArgs();
        }

        public Builder(GetMonitorAlertChannelsFilterArgs defaults) {
            $ = new GetMonitorAlertChannelsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMonitorAlertChannelsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMonitorAlertChannelsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMonitorAlertChannelsFilterArgs", "values");
            }
            return $;
        }
    }
