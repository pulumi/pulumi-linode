...
public final class GetStackScriptsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetStackScriptsFilter Empty = new GetStackScriptsFilter();
    ...
    private GetStackScriptsFilter(GetStackScriptsFilter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStackScriptsFilter();
        }

        public Builder(GetStackScriptsFilter defaults) {
            $ = new GetStackScriptsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetStackScriptsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetStackScriptsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetStackScriptsFilter", "values");
            }
            return $;
        }
    }
