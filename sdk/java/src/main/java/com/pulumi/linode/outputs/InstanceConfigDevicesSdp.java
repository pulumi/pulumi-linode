...
@CustomType
public final class InstanceConfigDevicesSdp {
    /**
    ...
    private InstanceConfigDevicesSdp() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdp defaults) {
        ...
        public InstanceConfigDevicesSdp build() {
            final var _resultValue = new InstanceConfigDevicesSdp();
