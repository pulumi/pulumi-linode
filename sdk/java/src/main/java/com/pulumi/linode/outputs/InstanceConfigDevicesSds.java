...
@CustomType
public final class InstanceConfigDevicesSds {
    /**
    ...
    private InstanceConfigDevicesSds() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSds defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSds defaults) {
        ...
        public InstanceConfigDevicesSds build() {
            final var _resultValue = new InstanceConfigDevicesSds();
