...
public final class GetLkeTypesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetLkeTypesFilter Empty = new GetLkeTypesFilter();
    ...
    private GetLkeTypesFilter(GetLkeTypesFilter $) {
    ...
    public static Builder builder(GetLkeTypesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLkeTypesFilter();
        }

        public Builder(GetLkeTypesFilter defaults) {
            $ = new GetLkeTypesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetLkeTypesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLkeTypesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLkeTypesFilter", "values");
            }
            return $;
        }
    }
