...
public final class GetAccountLoginsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetAccountLoginsFilter Empty = new GetAccountLoginsFilter();
    ...
    private GetAccountLoginsFilter() {}

    private GetAccountLoginsFilter(GetAccountLoginsFilter $) {
    ...
    public static Builder builder(GetAccountLoginsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAccountLoginsFilter();
        }

        public Builder(GetAccountLoginsFilter defaults) {
            $ = new GetAccountLoginsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetAccountLoginsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAccountLoginsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetAccountLoginsFilter", "values");
            }
            return $;
        }
    }
