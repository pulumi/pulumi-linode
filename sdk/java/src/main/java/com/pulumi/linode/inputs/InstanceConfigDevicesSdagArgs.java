...
public final class InstanceConfigDevicesSdagArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdagArgs Empty = new InstanceConfigDevicesSdagArgs();
    ...
    private InstanceConfigDevicesSdagArgs() {}

    private InstanceConfigDevicesSdagArgs(InstanceConfigDevicesSdagArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdagArgs();
        }

        public Builder(InstanceConfigDevicesSdagArgs defaults) {
            $ = new InstanceConfigDevicesSdagArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdagArgs build() {
            return $;
        }
    }
