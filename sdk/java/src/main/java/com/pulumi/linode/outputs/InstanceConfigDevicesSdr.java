...
@CustomType
public final class InstanceConfigDevicesSdr {
    /**
    ...
    private InstanceConfigDevicesSdr() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdr defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdr defaults) {
        ...
        public InstanceConfigDevicesSdr build() {
            final var _resultValue = new InstanceConfigDevicesSdr();
