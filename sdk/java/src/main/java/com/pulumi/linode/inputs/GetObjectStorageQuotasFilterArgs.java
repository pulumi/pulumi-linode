...
public final class GetObjectStorageQuotasFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetObjectStorageQuotasFilterArgs Empty = new GetObjectStorageQuotasFilterArgs();
    ...
    private GetObjectStorageQuotasFilterArgs() {}

    private GetObjectStorageQuotasFilterArgs(GetObjectStorageQuotasFilterArgs $) {
    ...
    public static Builder builder(GetObjectStorageQuotasFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetObjectStorageQuotasFilterArgs();
        }

        public Builder(GetObjectStorageQuotasFilterArgs defaults) {
            $ = new GetObjectStorageQuotasFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetObjectStorageQuotasFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetObjectStorageQuotasFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetObjectStorageQuotasFilterArgs", "values");
            }
            return $;
        }
    }
