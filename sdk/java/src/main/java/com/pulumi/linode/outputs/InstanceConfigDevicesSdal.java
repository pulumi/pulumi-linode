...
@CustomType
public final class InstanceConfigDevicesSdal {
    /**
    ...
    private InstanceConfigDevicesSdal() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdal defaults) {
        ...
        public InstanceConfigDevicesSdal build() {
            final var _resultValue = new InstanceConfigDevicesSdal();
