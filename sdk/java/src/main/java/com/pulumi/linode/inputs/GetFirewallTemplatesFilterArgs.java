...
public final class GetFirewallTemplatesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFirewallTemplatesFilterArgs Empty = new GetFirewallTemplatesFilterArgs();
    ...
    private GetFirewallTemplatesFilterArgs() {}

    private GetFirewallTemplatesFilterArgs(GetFirewallTemplatesFilterArgs $) {
    ...
    public static Builder builder(GetFirewallTemplatesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFirewallTemplatesFilterArgs();
        }

        public Builder(GetFirewallTemplatesFilterArgs defaults) {
            $ = new GetFirewallTemplatesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFirewallTemplatesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetFirewallTemplatesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetFirewallTemplatesFilterArgs", "values");
            }
            return $;
        }
    }
