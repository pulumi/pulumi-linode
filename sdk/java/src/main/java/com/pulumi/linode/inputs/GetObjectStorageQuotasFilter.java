...
public final class GetObjectStorageQuotasFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetObjectStorageQuotasFilter Empty = new GetObjectStorageQuotasFilter();
    ...
    private GetObjectStorageQuotasFilter() {}

    private GetObjectStorageQuotasFilter(GetObjectStorageQuotasFilter $) {
    ...
    public static Builder builder(GetObjectStorageQuotasFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetObjectStorageQuotasFilter();
        }

        public Builder(GetObjectStorageQuotasFilter defaults) {
            $ = new GetObjectStorageQuotasFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetObjectStorageQuotasFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetObjectStorageQuotasFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetObjectStorageQuotasFilter", "values");
            }
            return $;
        }
    }
