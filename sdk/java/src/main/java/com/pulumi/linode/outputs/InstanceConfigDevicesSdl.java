...
@CustomType
public final class InstanceConfigDevicesSdl {
    /**
    ...
    private InstanceConfigDevicesSdl() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdl defaults) {
        ...
        public InstanceConfigDevicesSdl build() {
            final var _resultValue = new InstanceConfigDevicesSdl();
