...
public final class InstanceConfigDevicesSdaaArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdaaArgs Empty = new InstanceConfigDevicesSdaaArgs();
    ...
    private InstanceConfigDevicesSdaaArgs() {}

    private InstanceConfigDevicesSdaaArgs(InstanceConfigDevicesSdaaArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdaaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdaaArgs();
        }

        public Builder(InstanceConfigDevicesSdaaArgs defaults) {
            $ = new InstanceConfigDevicesSdaaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdaaArgs build() {
            return $;
        }
    }
