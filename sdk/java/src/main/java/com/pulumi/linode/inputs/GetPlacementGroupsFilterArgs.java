...
public final class GetPlacementGroupsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPlacementGroupsFilterArgs Empty = new GetPlacementGroupsFilterArgs();
    ...
    private GetPlacementGroupsFilterArgs() {}

    private GetPlacementGroupsFilterArgs(GetPlacementGroupsFilterArgs $) {
    ...
    public static Builder builder(GetPlacementGroupsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPlacementGroupsFilterArgs();
        }

        public Builder(GetPlacementGroupsFilterArgs defaults) {
            $ = new GetPlacementGroupsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPlacementGroupsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPlacementGroupsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetPlacementGroupsFilterArgs", "values");
            }
            return $;
        }
    }
