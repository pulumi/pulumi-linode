...
public final class InstanceConfigDevicesSdbkArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbkArgs Empty = new InstanceConfigDevicesSdbkArgs();
    ...
    private InstanceConfigDevicesSdbkArgs() {}

    private InstanceConfigDevicesSdbkArgs(InstanceConfigDevicesSdbkArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbkArgs();
        }

        public Builder(InstanceConfigDevicesSdbkArgs defaults) {
            $ = new InstanceConfigDevicesSdbkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbkArgs build() {
            return $;
        }
    }
