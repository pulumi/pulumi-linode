...
public final class GetUserDomainGrantArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetUserDomainGrantArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserDomainGrantArgs", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserDomainGrantArgs", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserDomainGrantArgs", "permissions");
            }
            return $;
        }
    }
