...
@CustomType
public final class InstanceConfigDevicesSday {
    /**
    ...
    private InstanceConfigDevicesSday() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSday defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSday defaults) {
        ...
        public InstanceConfigDevicesSday build() {
            final var _resultValue = new InstanceConfigDevicesSday();
