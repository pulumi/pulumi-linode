...
public final class InstanceConfigDevicesSdanArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdanArgs Empty = new InstanceConfigDevicesSdanArgs();
    ...
    private InstanceConfigDevicesSdanArgs() {}

    private InstanceConfigDevicesSdanArgs(InstanceConfigDevicesSdanArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdanArgs();
        }

        public Builder(InstanceConfigDevicesSdanArgs defaults) {
            $ = new InstanceConfigDevicesSdanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdanArgs build() {
            return $;
        }
    }
