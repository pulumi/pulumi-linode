...
@CustomType
public final class RdnsTimeouts {
    /**
    ...
    public static Builder builder(RdnsTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(RdnsTimeouts defaults) {
        ...
        public RdnsTimeouts build() {
            final var _resultValue = new RdnsTimeouts();
