...
@CustomType
public final class InstanceConfigDevicesSdaj {
    /**
    ...
    private InstanceConfigDevicesSdaj() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdaj defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdaj defaults) {
        ...
        public InstanceConfigDevicesSdaj build() {
            final var _resultValue = new InstanceConfigDevicesSdaj();
