...
public final class InstanceConfigDevicesSdbaArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbaArgs Empty = new InstanceConfigDevicesSdbaArgs();
    ...
    private InstanceConfigDevicesSdbaArgs() {}

    private InstanceConfigDevicesSdbaArgs(InstanceConfigDevicesSdbaArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbaArgs();
        }

        public Builder(InstanceConfigDevicesSdbaArgs defaults) {
            $ = new InstanceConfigDevicesSdbaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbaArgs build() {
            return $;
        }
    }
