...
public final class InstanceConfigDevicesSdakArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdakArgs Empty = new InstanceConfigDevicesSdakArgs();
    ...
    private InstanceConfigDevicesSdakArgs() {}

    private InstanceConfigDevicesSdakArgs(InstanceConfigDevicesSdakArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdakArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdakArgs();
        }

        public Builder(InstanceConfigDevicesSdakArgs defaults) {
            $ = new InstanceConfigDevicesSdakArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdakArgs build() {
            return $;
        }
    }
