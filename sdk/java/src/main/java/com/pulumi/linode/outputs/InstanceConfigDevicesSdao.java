...
@CustomType
public final class InstanceConfigDevicesSdao {
    /**
    ...
    private InstanceConfigDevicesSdao() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdao defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdao defaults) {
        ...
        public InstanceConfigDevicesSdao build() {
            final var _resultValue = new InstanceConfigDevicesSdao();
