...
public final class StackScriptUserDefinedField {
    ...
    public static final class Builder {
        ...
        public Builder default_(String default_) {
            if (default_ == null) {
              throw new MissingRequiredPropertyException("StackScriptUserDefinedField", "default_");
            }
        ...
        public Builder example(String example) {
            if (example == null) {
              throw new MissingRequiredPropertyException("StackScriptUserDefinedField", "example");
            }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("StackScriptUserDefinedField", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder manyOf(String manyOf) {
            if (manyOf == null) {
              throw new MissingRequiredPropertyException("StackScriptUserDefinedField", "manyOf");
            }
            this.manyOf = manyOf;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("StackScriptUserDefinedField", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder oneOf(String oneOf) {
            if (oneOf == null) {
              throw new MissingRequiredPropertyException("StackScriptUserDefinedField", "oneOf");
            }
            this.oneOf = oneOf;
            return this;
        }
        public StackScriptUserDefinedField build() {
            final var _resultValue = new StackScriptUserDefinedField();
