...
@CustomType
public final class InstanceConfigDevicesSdz {
    /**
    ...
    private InstanceConfigDevicesSdz() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdz defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdz defaults) {
        ...
        public InstanceConfigDevicesSdz build() {
            final var _resultValue = new InstanceConfigDevicesSdz();
