...
public final class GetLkeClustersFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetLkeClustersFilter Empty = new GetLkeClustersFilter();
    ...
    private GetLkeClustersFilter() {}

    private GetLkeClustersFilter(GetLkeClustersFilter $) {
    ...
    public static Builder builder(GetLkeClustersFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLkeClustersFilter();
        }

        public Builder(GetLkeClustersFilter defaults) {
            $ = new GetLkeClustersFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetLkeClustersFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLkeClustersFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLkeClustersFilter", "values");
            }
            return $;
        }
    }
