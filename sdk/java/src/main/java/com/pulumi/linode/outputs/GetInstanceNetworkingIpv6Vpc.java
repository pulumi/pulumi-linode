...
import com.pulumi.linode.outputs.GetInstanceNetworkingIpv6VpcIpv6Address;
...
@CustomType
public final class GetInstanceNetworkingIpv6Vpc {
    /**
     ...
     * 
     */
    private List<GetInstanceNetworkingIpv6VpcIpv6Address> ipv6Addresses;
    /**
    ...
    private GetInstanceNetworkingIpv6Vpc() {}
    /**
     * @return Returns `true` if the VPC interface is in use, meaning that the Linode was powered on using the `configId` to which the interface belongs. Otherwise returns `false`.
     * 
     */
     ...
     * 
     */
    public List<GetInstanceNetworkingIpv6VpcIpv6Address> ipv6Addresses() {
    ...
    public static Builder builder(GetInstanceNetworkingIpv6Vpc defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vpcId;
        public Builder() {}
        public Builder(GetInstanceNetworkingIpv6Vpc defaults) {
        ...
        public Builder active(Boolean active) {
            if (active == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "active");
            }
            this.active = active;
            return this;
        }
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "address");
            }
        ...
        public Builder addressRange(String addressRange) {
            if (addressRange == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "addressRange");
            }
        ...
        public Builder configId(Integer configId) {
            if (configId == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "configId");
            }
        ...
        public Builder gateway(String gateway) {
            if (gateway == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "gateway");
            }
        ...
        public Builder interfaceId(Integer interfaceId) {
            if (interfaceId == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "interfaceId");
            }
            this.interfaceId = interfaceId;
            return this;
        }
        @CustomType.Setter
        public Builder ipv6Addresses(List<GetInstanceNetworkingIpv6VpcIpv6Address> ipv6Addresses) {
            if (ipv6Addresses == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "ipv6Addresses");
            }
            this.ipv6Addresses = ipv6Addresses;
            return this;
        }
        public Builder ipv6Addresses(GetInstanceNetworkingIpv6VpcIpv6Address... ipv6Addresses) {
            return ipv6Addresses(List.of(ipv6Addresses));
        }
        @CustomType.Setter
        public Builder ipv6IsPublic(Boolean ipv6IsPublic) {
            if (ipv6IsPublic == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "ipv6IsPublic");
            }
        ...
        public Builder ipv6Range(String ipv6Range) {
            if (ipv6Range == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "ipv6Range");
            }
        ...
        public Builder linodeId(Integer linodeId) {
            if (linodeId == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "linodeId");
            }
        ...
        public Builder nat11(String nat11) {
            if (nat11 == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "nat11");
            }
            this.nat11 = nat11;
            return this;
        }
        ...
        public Builder prefix(Integer prefix) {
            if (prefix == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "prefix");
            }
            this.prefix = prefix;
            return this;
        }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "region");
            }
            this.region = region;
            return this;
        }
        ...
        public Builder subnetId(Integer subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "subnetId");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "subnetMask");
            }
        ...
        public Builder vpcId(Integer vpcId) {
            if (vpcId == null) {
              throw new MissingRequiredPropertyException("GetInstanceNetworkingIpv6Vpc", "vpcId");
            }
            this.vpcId = vpcId;
            return this;
        }
        public GetInstanceNetworkingIpv6Vpc build() {
            final var _resultValue = new GetInstanceNetworkingIpv6Vpc();
