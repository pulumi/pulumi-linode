...
public final class InstanceConfigDevicesSdhArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdhArgs Empty = new InstanceConfigDevicesSdhArgs();
    ...
    private InstanceConfigDevicesSdhArgs() {}
    ...
    public static Builder builder(InstanceConfigDevicesSdhArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdhArgs();
        }

        public Builder(InstanceConfigDevicesSdhArgs defaults) {
            $ = new InstanceConfigDevicesSdhArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdhArgs build() {
            return $;
        }
    }
