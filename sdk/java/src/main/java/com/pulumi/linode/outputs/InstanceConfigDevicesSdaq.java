...
@CustomType
public final class InstanceConfigDevicesSdaq {
    /**
    ...
    private InstanceConfigDevicesSdaq() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdaq defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdaq defaults) {
        ...
        public InstanceConfigDevicesSdaq build() {
            final var _resultValue = new InstanceConfigDevicesSdaq();
