...
public final class GetKernelsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetKernelsFilter Empty = new GetKernelsFilter();
    ...
    private GetKernelsFilter() {}

    private GetKernelsFilter(GetKernelsFilter $) {
    ...
    public static Builder builder(GetKernelsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKernelsFilter();
        }

        public Builder(GetKernelsFilter defaults) {
            $ = new GetKernelsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetKernelsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetKernelsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetKernelsFilter", "values");
            }
            return $;
        }
    }
