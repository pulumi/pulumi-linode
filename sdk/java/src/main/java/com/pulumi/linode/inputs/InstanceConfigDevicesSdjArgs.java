...
public final class InstanceConfigDevicesSdjArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdjArgs Empty = new InstanceConfigDevicesSdjArgs();
    ...
    private InstanceConfigDevicesSdjArgs() {}

    private InstanceConfigDevicesSdjArgs(InstanceConfigDevicesSdjArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdjArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdjArgs();
        }

        public Builder(InstanceConfigDevicesSdjArgs defaults) {
            $ = new InstanceConfigDevicesSdjArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdjArgs build() {
            return $;
        }
    }
