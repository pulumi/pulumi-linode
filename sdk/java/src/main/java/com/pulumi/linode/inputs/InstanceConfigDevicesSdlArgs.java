...
public final class InstanceConfigDevicesSdlArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdlArgs Empty = new InstanceConfigDevicesSdlArgs();
    ...
    private InstanceConfigDevicesSdlArgs() {}

    private InstanceConfigDevicesSdlArgs(InstanceConfigDevicesSdlArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdlArgs();
        }

        public Builder(InstanceConfigDevicesSdlArgs defaults) {
            $ = new InstanceConfigDevicesSdlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdlArgs build() {
            return $;
        }
    }
