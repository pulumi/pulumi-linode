...
public final class InstanceConfigDevicesSduArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSduArgs Empty = new InstanceConfigDevicesSduArgs();
    ...
    private InstanceConfigDevicesSduArgs() {}

    private InstanceConfigDevicesSduArgs(InstanceConfigDevicesSduArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSduArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSduArgs();
        }

        public Builder(InstanceConfigDevicesSduArgs defaults) {
            $ = new InstanceConfigDevicesSduArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSduArgs build() {
            return $;
        }
    }
