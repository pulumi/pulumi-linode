...
@CustomType
public final class InterfacePublicIpv6AssignedRange {
    /**
    ...
    public static Builder builder(InterfacePublicIpv6AssignedRange defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeTarget;
        public Builder() {}
        public Builder(InterfacePublicIpv6AssignedRange defaults) {
        ...
        public InterfacePublicIpv6AssignedRange build() {
            final var _resultValue = new InterfacePublicIpv6AssignedRange();
