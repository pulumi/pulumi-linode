...
public final class GetUserVolumeGrantArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetUserVolumeGrantArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserVolumeGrantArgs", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserVolumeGrantArgs", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserVolumeGrantArgs", "permissions");
            }
            return $;
        }
    }
