...
@CustomType
public final class InstanceConfigDevicesSdbd {
    /**
    ...
    private InstanceConfigDevicesSdbd() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbd defaults) {
        ...
        public InstanceConfigDevicesSdbd build() {
            final var _resultValue = new InstanceConfigDevicesSdbd();
