...
public final class GetNodebalancerVpcsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetNodebalancerVpcsFilterArgs Empty = new GetNodebalancerVpcsFilterArgs();
    ...
    private GetNodebalancerVpcsFilterArgs() {}

    private GetNodebalancerVpcsFilterArgs(GetNodebalancerVpcsFilterArgs $) {
    ...
    public static Builder builder(GetNodebalancerVpcsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancerVpcsFilterArgs();
        }

        public Builder(GetNodebalancerVpcsFilterArgs defaults) {
            $ = new GetNodebalancerVpcsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodebalancerVpcsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerVpcsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerVpcsFilterArgs", "values");
            }
            return $;
        }
    }
