...
@CustomType
public final class InstanceConfigDevicesSdac {
    /**
    ...
    private InstanceConfigDevicesSdac() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdac defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdac defaults) {
        ...
        public InstanceConfigDevicesSdac build() {
            final var _resultValue = new InstanceConfigDevicesSdac();
