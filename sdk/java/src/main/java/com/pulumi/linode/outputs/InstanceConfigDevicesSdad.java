...
@CustomType
public final class InstanceConfigDevicesSdad {
    /**
    ...
    private InstanceConfigDevicesSdad() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdad defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdad defaults) {
        ...
        public InstanceConfigDevicesSdad build() {
            final var _resultValue = new InstanceConfigDevicesSdad();
