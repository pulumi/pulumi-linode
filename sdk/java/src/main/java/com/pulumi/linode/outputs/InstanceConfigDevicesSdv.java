...
@CustomType
public final class InstanceConfigDevicesSdv {
    /**
    ...
    private InstanceConfigDevicesSdv() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdv defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdv defaults) {
        ...
        public InstanceConfigDevicesSdv build() {
            final var _resultValue = new InstanceConfigDevicesSdv();
