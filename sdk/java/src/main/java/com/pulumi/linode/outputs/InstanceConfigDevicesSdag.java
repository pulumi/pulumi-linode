...
@CustomType
public final class InstanceConfigDevicesSdag {
    /**
    ...
    private InstanceConfigDevicesSdag() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdag defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdag defaults) {
        ...
        public InstanceConfigDevicesSdag build() {
            final var _resultValue = new InstanceConfigDevicesSdag();
