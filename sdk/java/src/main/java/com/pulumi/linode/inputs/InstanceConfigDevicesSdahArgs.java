...
public final class InstanceConfigDevicesSdahArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdahArgs Empty = new InstanceConfigDevicesSdahArgs();
    ...
    private InstanceConfigDevicesSdahArgs() {}

    private InstanceConfigDevicesSdahArgs(InstanceConfigDevicesSdahArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdahArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdahArgs();
        }

        public Builder(InstanceConfigDevicesSdahArgs defaults) {
            $ = new InstanceConfigDevicesSdahArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdahArgs build() {
            return $;
        }
    }
