...
public final class GetKernelsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKernelsFilterArgs Empty = new GetKernelsFilterArgs();
    ...
    private GetKernelsFilterArgs() {}

    private GetKernelsFilterArgs(GetKernelsFilterArgs $) {
    ...
    public static Builder builder(GetKernelsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKernelsFilterArgs();
        }

        public Builder(GetKernelsFilterArgs defaults) {
            $ = new GetKernelsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetKernelsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetKernelsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetKernelsFilterArgs", "values");
            }
            return $;
        }
    }
