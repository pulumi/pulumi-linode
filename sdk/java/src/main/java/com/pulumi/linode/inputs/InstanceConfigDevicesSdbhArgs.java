...
public final class InstanceConfigDevicesSdbhArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbhArgs Empty = new InstanceConfigDevicesSdbhArgs();
    ...
    private InstanceConfigDevicesSdbhArgs() {}

    private InstanceConfigDevicesSdbhArgs(InstanceConfigDevicesSdbhArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbhArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbhArgs();
        }

        public Builder(InstanceConfigDevicesSdbhArgs defaults) {
            $ = new InstanceConfigDevicesSdbhArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbhArgs build() {
            return $;
        }
    }
