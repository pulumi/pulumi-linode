...
public final class GetInstanceBackupsInProgress {
    ...
    private final List<GetInstanceBackupsInProgressDisk> disks;
    /**
    ...
    private GetInstanceBackupsInProgress(
        ...
        @CustomType.Parameter("disks") List<GetInstanceBackupsInProgressDisk> disks,
    ...
    public static final class Builder {
        ...
        public Builder updated(String updated) {
            ...
            return new GetInstanceBackupsInProgress(configs, created, disks, finished, id, label, status, type, updated);
        }
    }
}
