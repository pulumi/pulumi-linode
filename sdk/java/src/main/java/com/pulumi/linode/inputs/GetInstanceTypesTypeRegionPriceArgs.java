...
public final class GetInstanceTypesTypeRegionPriceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetInstanceTypesTypeRegionPriceArgs Empty = new GetInstanceTypesTypeRegionPriceArgs();
    ...
    private GetInstanceTypesTypeRegionPriceArgs() {}

    private GetInstanceTypesTypeRegionPriceArgs(GetInstanceTypesTypeRegionPriceArgs $) {
        this.hourly = $.hourly;
        this.id = $.id;
    ...
    public static Builder builder(GetInstanceTypesTypeRegionPriceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInstanceTypesTypeRegionPriceArgs();
        }

        public Builder(GetInstanceTypesTypeRegionPriceArgs defaults) {
            $ = new GetInstanceTypesTypeRegionPriceArgs(Objects.requireNonNull(defaults));
        }
