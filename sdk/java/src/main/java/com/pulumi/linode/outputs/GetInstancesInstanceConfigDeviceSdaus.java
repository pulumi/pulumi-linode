...
@CustomType
public final class GetInstancesInstanceConfigDeviceSdaus {
    /**
    ...
    private GetInstancesInstanceConfigDeviceSdaus() {}
    /**
     * @return The Disk ID of the associated `diskLabel`, if used
     * 
     */
    ...
    public static Builder builder(GetInstancesInstanceConfigDeviceSdaus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(GetInstancesInstanceConfigDeviceSdaus defaults) {
        ...
        public Builder diskId(Integer diskId) {
            if (diskId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceConfigDeviceSdaus", "diskId");
            }
            this.diskId = diskId;
            return this;
        }
        ...
        public GetInstancesInstanceConfigDeviceSdaus build() {
            final var _resultValue = new GetInstancesInstanceConfigDeviceSdaus();
