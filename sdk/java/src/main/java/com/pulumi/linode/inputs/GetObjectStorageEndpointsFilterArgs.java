...
public final class GetObjectStorageEndpointsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetObjectStorageEndpointsFilterArgs Empty = new GetObjectStorageEndpointsFilterArgs();
    ...
    private GetObjectStorageEndpointsFilterArgs() {}

    private GetObjectStorageEndpointsFilterArgs(GetObjectStorageEndpointsFilterArgs $) {
    ...
    public static Builder builder(GetObjectStorageEndpointsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetObjectStorageEndpointsFilterArgs();
        }

        public Builder(GetObjectStorageEndpointsFilterArgs defaults) {
            $ = new GetObjectStorageEndpointsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetObjectStorageEndpointsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetObjectStorageEndpointsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetObjectStorageEndpointsFilterArgs", "values");
            }
            return $;
        }
    }
