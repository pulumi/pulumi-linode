...
public final class DatabaseMysqlV2TimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseMysqlV2TimeoutsArgs Empty = new DatabaseMysqlV2TimeoutsArgs();
    ...
    private DatabaseMysqlV2TimeoutsArgs() {}

    private DatabaseMysqlV2TimeoutsArgs(DatabaseMysqlV2TimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(DatabaseMysqlV2TimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseMysqlV2TimeoutsArgs();
        }

        public Builder(DatabaseMysqlV2TimeoutsArgs defaults) {
            $ = new DatabaseMysqlV2TimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseMysqlV2TimeoutsArgs build() {
            return $;
        }
    }
