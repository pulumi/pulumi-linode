...
public final class GetNodebalancerVpcsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetNodebalancerVpcsFilter Empty = new GetNodebalancerVpcsFilter();
    ...
    private GetNodebalancerVpcsFilter() {}

    private GetNodebalancerVpcsFilter(GetNodebalancerVpcsFilter $) {
    ...
    public static Builder builder(GetNodebalancerVpcsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancerVpcsFilter();
        }

        public Builder(GetNodebalancerVpcsFilter defaults) {
            $ = new GetNodebalancerVpcsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodebalancerVpcsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerVpcsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerVpcsFilter", "values");
            }
            return $;
        }
    }
