...
public final class GetUsersUserNodebalancerGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUsersUserNodebalancerGrant Empty = new GetUsersUserNodebalancerGrant();
    ...
    private GetUsersUserNodebalancerGrant(GetUsersUserNodebalancerGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUsersUserNodebalancerGrant();
        }

        public Builder(GetUsersUserNodebalancerGrant defaults) {
            $ = new GetUsersUserNodebalancerGrant(Objects.requireNonNull(defaults));
        }
