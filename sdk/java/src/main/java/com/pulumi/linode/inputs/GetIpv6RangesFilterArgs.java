...
public final class GetIpv6RangesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetIpv6RangesFilterArgs Empty = new GetIpv6RangesFilterArgs();
    ...
    private GetIpv6RangesFilterArgs() {}

    private GetIpv6RangesFilterArgs(GetIpv6RangesFilterArgs $) {
    ...
    public static Builder builder(GetIpv6RangesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIpv6RangesFilterArgs();
        }

        public Builder(GetIpv6RangesFilterArgs defaults) {
            $ = new GetIpv6RangesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIpv6RangesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetIpv6RangesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetIpv6RangesFilterArgs", "values");
            }
            return $;
        }
    }
