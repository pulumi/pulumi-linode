...
@CustomType
public final class InstanceConfigDevicesSdbj {
    /**
    ...
    private InstanceConfigDevicesSdbj() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbj defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbj defaults) {
        ...
        public InstanceConfigDevicesSdbj build() {
            final var _resultValue = new InstanceConfigDevicesSdbj();
