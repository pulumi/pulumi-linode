...
@CustomType
public final class InstanceConfigDevicesSdax {
    /**
    ...
    private InstanceConfigDevicesSdax() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdax defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdax defaults) {
        ...
        public InstanceConfigDevicesSdax build() {
            final var _resultValue = new InstanceConfigDevicesSdax();
