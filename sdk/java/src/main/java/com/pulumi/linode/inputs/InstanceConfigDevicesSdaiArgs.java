...
public final class InstanceConfigDevicesSdaiArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdaiArgs Empty = new InstanceConfigDevicesSdaiArgs();
    ...
    private InstanceConfigDevicesSdaiArgs() {}

    private InstanceConfigDevicesSdaiArgs(InstanceConfigDevicesSdaiArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdaiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdaiArgs();
        }

        public Builder(InstanceConfigDevicesSdaiArgs defaults) {
            $ = new InstanceConfigDevicesSdaiArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdaiArgs build() {
            return $;
        }
    }
