...
public final class InstanceConfigDevicesSdamArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdamArgs Empty = new InstanceConfigDevicesSdamArgs();
    ...
    private InstanceConfigDevicesSdamArgs() {}

    private InstanceConfigDevicesSdamArgs(InstanceConfigDevicesSdamArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdamArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdamArgs();
        }

        public Builder(InstanceConfigDevicesSdamArgs defaults) {
            $ = new InstanceConfigDevicesSdamArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdamArgs build() {
            return $;
        }
    }
