...
public final class GetVolumeTypesFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetVolumeTypesFilter(GetVolumeTypesFilter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVolumeTypesFilter();
        }

        public Builder(GetVolumeTypesFilter defaults) {
            $ = new GetVolumeTypesFilter(Objects.requireNonNull(defaults));
        }
