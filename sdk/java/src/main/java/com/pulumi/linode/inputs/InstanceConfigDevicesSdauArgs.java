...
public final class InstanceConfigDevicesSdauArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdauArgs Empty = new InstanceConfigDevicesSdauArgs();
    ...
    private InstanceConfigDevicesSdauArgs() {}

    private InstanceConfigDevicesSdauArgs(InstanceConfigDevicesSdauArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdauArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdauArgs();
        }

        public Builder(InstanceConfigDevicesSdauArgs defaults) {
            $ = new InstanceConfigDevicesSdauArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdauArgs build() {
            return $;
        }
    }
