...
@CustomType
public final class InstanceInterfaceIpv4 {
    /**
    ...
    public static Builder builder(InstanceInterfaceIpv4 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpc;
        public Builder() {}
        public Builder(InstanceInterfaceIpv4 defaults) {
        ...
        public InstanceInterfaceIpv4 build() {
            final var _resultValue = new InstanceInterfaceIpv4();
