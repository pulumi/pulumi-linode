...
@CustomType
public final class InstanceConfigDevicesSdx {
    /**
    ...
    private InstanceConfigDevicesSdx() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdx defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdx defaults) {
        ...
        public InstanceConfigDevicesSdx build() {
            final var _resultValue = new InstanceConfigDevicesSdx();
