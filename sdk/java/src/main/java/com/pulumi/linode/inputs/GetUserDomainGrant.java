...
public final class GetUserDomainGrant extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetUserDomainGrant build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserDomainGrant", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserDomainGrant", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserDomainGrant", "permissions");
            }
            return $;
        }
    }
