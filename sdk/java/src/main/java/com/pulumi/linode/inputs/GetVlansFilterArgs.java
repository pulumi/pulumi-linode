...
public final class GetVlansFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetVlansFilterArgs Empty = new GetVlansFilterArgs();
    ...
    private GetVlansFilterArgs() {}

    private GetVlansFilterArgs(GetVlansFilterArgs $) {
    ...
    public static Builder builder(GetVlansFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVlansFilterArgs();
        }

        public Builder(GetVlansFilterArgs defaults) {
            $ = new GetVlansFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVlansFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVlansFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVlansFilterArgs", "values");
            }
            return $;
        }
    }
