...
public final class GetLkeClustersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLkeClustersArgs Empty = new GetLkeClustersArgs();

    @Import(name="filters")
    private @Nullable Output<List<GetLkeClustersFilterArgs>> filters;
    ...
    public static Builder builder(GetLkeClustersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLkeClustersArgs();
        }

        public Builder(GetLkeClustersArgs defaults) {
            $ = new GetLkeClustersArgs(Objects.requireNonNull(defaults));
        }

        public Builder filters(@Nullable Output<List<GetLkeClustersFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetLkeClustersFilterArgs> filters) {
        ...
        public GetLkeClustersArgs build() {
            return $;
        }
    }
