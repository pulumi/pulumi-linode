...
public final class GetUserPlacementGroupGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUserPlacementGroupGrant Empty = new GetUserPlacementGroupGrant();
    ...
    private GetUserPlacementGroupGrant(GetUserPlacementGroupGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUserPlacementGroupGrant();
        }

        public Builder(GetUserPlacementGroupGrant defaults) {
            $ = new GetUserPlacementGroupGrant(Objects.requireNonNull(defaults));
        }
