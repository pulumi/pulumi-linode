...
public class NodeBalancer extends com.pulumi.resources.CustomResource {
     ...
     */
    public NodeBalancer(java.lang.String name) {
     ...
     */
    public NodeBalancer(java.lang.String name, @Nullable NodeBalancerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NodeBalancer(java.lang.String name, @Nullable NodeBalancerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("linode:index/nodeBalancer:NodeBalancer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NodeBalancer(java.lang.String name, Output<java.lang.String> id, @Nullable NodeBalancerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("linode:index/nodeBalancer:NodeBalancer", name, state, makeResourceOptions(options, id), false);
    }

    private static NodeBalancerArgs makeArgs(@Nullable NodeBalancerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NodeBalancerArgs.Empty : args;
    }
     ...
     */
    public static NodeBalancer get(java.lang.String name, Output<java.lang.String> id, @Nullable NodeBalancerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
