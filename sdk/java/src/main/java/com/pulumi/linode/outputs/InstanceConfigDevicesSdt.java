...
@CustomType
public final class InstanceConfigDevicesSdt {
    /**
    ...
    private InstanceConfigDevicesSdt() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdt defaults) {
        ...
        public InstanceConfigDevicesSdt build() {
            final var _resultValue = new InstanceConfigDevicesSdt();
