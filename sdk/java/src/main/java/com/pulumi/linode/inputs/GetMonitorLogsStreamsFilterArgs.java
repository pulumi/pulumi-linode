...
public final class GetMonitorLogsStreamsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMonitorLogsStreamsFilterArgs Empty = new GetMonitorLogsStreamsFilterArgs();
    ...
    private GetMonitorLogsStreamsFilterArgs() {}

    private GetMonitorLogsStreamsFilterArgs(GetMonitorLogsStreamsFilterArgs $) {
    ...
    public static Builder builder(GetMonitorLogsStreamsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMonitorLogsStreamsFilterArgs();
        }

        public Builder(GetMonitorLogsStreamsFilterArgs defaults) {
            $ = new GetMonitorLogsStreamsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMonitorLogsStreamsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMonitorLogsStreamsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMonitorLogsStreamsFilterArgs", "values");
            }
            return $;
        }
    }
