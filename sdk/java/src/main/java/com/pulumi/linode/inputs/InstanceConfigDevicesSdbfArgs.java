...
public final class InstanceConfigDevicesSdbfArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbfArgs Empty = new InstanceConfigDevicesSdbfArgs();
    ...
    private InstanceConfigDevicesSdbfArgs() {}

    private InstanceConfigDevicesSdbfArgs(InstanceConfigDevicesSdbfArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbfArgs();
        }

        public Builder(InstanceConfigDevicesSdbfArgs defaults) {
            $ = new InstanceConfigDevicesSdbfArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbfArgs build() {
            return $;
        }
    }
