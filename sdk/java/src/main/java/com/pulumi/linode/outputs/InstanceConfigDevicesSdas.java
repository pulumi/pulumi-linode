...
@CustomType
public final class InstanceConfigDevicesSdas {
    /**
    ...
    private InstanceConfigDevicesSdas() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdas defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdas defaults) {
        ...
        public InstanceConfigDevicesSdas build() {
            final var _resultValue = new InstanceConfigDevicesSdas();
