...
public final class InstanceConfigDevicesSdmArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdmArgs Empty = new InstanceConfigDevicesSdmArgs();
    ...
    private InstanceConfigDevicesSdmArgs() {}

    private InstanceConfigDevicesSdmArgs(InstanceConfigDevicesSdmArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdmArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdmArgs();
        }

        public Builder(InstanceConfigDevicesSdmArgs defaults) {
            $ = new InstanceConfigDevicesSdmArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdmArgs build() {
            return $;
        }
    }
