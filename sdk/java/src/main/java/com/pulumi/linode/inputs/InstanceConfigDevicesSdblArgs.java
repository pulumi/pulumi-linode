...
public final class InstanceConfigDevicesSdblArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdblArgs Empty = new InstanceConfigDevicesSdblArgs();
    ...
    private InstanceConfigDevicesSdblArgs() {}

    private InstanceConfigDevicesSdblArgs(InstanceConfigDevicesSdblArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdblArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdblArgs();
        }

        public Builder(InstanceConfigDevicesSdblArgs defaults) {
            $ = new InstanceConfigDevicesSdblArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdblArgs build() {
            return $;
        }
    }
