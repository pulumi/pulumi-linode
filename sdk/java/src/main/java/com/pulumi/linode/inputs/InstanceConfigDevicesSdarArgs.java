...
public final class InstanceConfigDevicesSdarArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdarArgs Empty = new InstanceConfigDevicesSdarArgs();
    ...
    private InstanceConfigDevicesSdarArgs() {}

    private InstanceConfigDevicesSdarArgs(InstanceConfigDevicesSdarArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdarArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdarArgs();
        }

        public Builder(InstanceConfigDevicesSdarArgs defaults) {
            $ = new InstanceConfigDevicesSdarArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdarArgs build() {
            return $;
        }
    }
