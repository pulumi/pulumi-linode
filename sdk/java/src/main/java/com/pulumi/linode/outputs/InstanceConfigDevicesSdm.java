...
@CustomType
public final class InstanceConfigDevicesSdm {
    /**
    ...
    private InstanceConfigDevicesSdm() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdm defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdm defaults) {
        ...
        public InstanceConfigDevicesSdm build() {
            final var _resultValue = new InstanceConfigDevicesSdm();
