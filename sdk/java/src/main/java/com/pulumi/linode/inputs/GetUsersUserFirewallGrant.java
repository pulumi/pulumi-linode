...
public final class GetUsersUserFirewallGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUsersUserFirewallGrant Empty = new GetUsersUserFirewallGrant();
    ...
    private GetUsersUserFirewallGrant(GetUsersUserFirewallGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUsersUserFirewallGrant();
        }

        public Builder(GetUsersUserFirewallGrant defaults) {
            $ = new GetUsersUserFirewallGrant(Objects.requireNonNull(defaults));
        }
