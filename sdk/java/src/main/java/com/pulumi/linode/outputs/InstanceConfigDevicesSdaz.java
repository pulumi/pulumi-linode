...
@CustomType
public final class InstanceConfigDevicesSdaz {
    /**
    ...
    private InstanceConfigDevicesSdaz() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdaz defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdaz defaults) {
        ...
        public InstanceConfigDevicesSdaz build() {
            final var _resultValue = new InstanceConfigDevicesSdaz();
