...
@CustomType
public final class InstanceConfigDevicesSdn {
    /**
    ...
    private InstanceConfigDevicesSdn() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdn defaults) {
        ...
        public InstanceConfigDevicesSdn build() {
            final var _resultValue = new InstanceConfigDevicesSdn();
