...
public final class InstanceConfigDevicesSdbbArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbbArgs Empty = new InstanceConfigDevicesSdbbArgs();
    ...
    private InstanceConfigDevicesSdbbArgs() {}

    private InstanceConfigDevicesSdbbArgs(InstanceConfigDevicesSdbbArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbbArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbbArgs();
        }

        public Builder(InstanceConfigDevicesSdbbArgs defaults) {
            $ = new InstanceConfigDevicesSdbbArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbbArgs build() {
            return $;
        }
    }
