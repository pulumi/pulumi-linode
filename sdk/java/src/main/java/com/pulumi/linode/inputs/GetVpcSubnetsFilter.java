...
public final class GetVpcSubnetsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetVpcSubnetsFilter Empty = new GetVpcSubnetsFilter();
    ...
    private GetVpcSubnetsFilter(GetVpcSubnetsFilter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpcSubnetsFilter();
        }

        public Builder(GetVpcSubnetsFilter defaults) {
            $ = new GetVpcSubnetsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetVpcSubnetsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVpcSubnetsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVpcSubnetsFilter", "values");
            }
            return $;
        }
    }
