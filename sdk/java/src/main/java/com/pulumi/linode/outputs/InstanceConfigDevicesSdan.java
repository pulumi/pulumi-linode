...
@CustomType
public final class InstanceConfigDevicesSdan {
    /**
    ...
    private InstanceConfigDevicesSdan() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdan defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdan defaults) {
        ...
        public InstanceConfigDevicesSdan build() {
            final var _resultValue = new InstanceConfigDevicesSdan();
