...
public final class GetAccountLoginsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAccountLoginsFilterArgs Empty = new GetAccountLoginsFilterArgs();
    ...
    private GetAccountLoginsFilterArgs() {}

    private GetAccountLoginsFilterArgs(GetAccountLoginsFilterArgs $) {
    ...
    public static Builder builder(GetAccountLoginsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAccountLoginsFilterArgs();
        }

        public Builder(GetAccountLoginsFilterArgs defaults) {
            $ = new GetAccountLoginsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAccountLoginsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAccountLoginsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetAccountLoginsFilterArgs", "values");
            }
            return $;
        }
    }
