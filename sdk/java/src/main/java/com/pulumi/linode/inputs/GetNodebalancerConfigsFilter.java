...
public final class GetNodebalancerConfigsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetNodebalancerConfigsFilter Empty = new GetNodebalancerConfigsFilter();
    ...
    private GetNodebalancerConfigsFilter() {}

    private GetNodebalancerConfigsFilter(GetNodebalancerConfigsFilter $) {
    ...
    public static Builder builder(GetNodebalancerConfigsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancerConfigsFilter();
        }

        public Builder(GetNodebalancerConfigsFilter defaults) {
            $ = new GetNodebalancerConfigsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodebalancerConfigsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerConfigsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetNodebalancerConfigsFilter", "values");
            }
            return $;
        }
    }
