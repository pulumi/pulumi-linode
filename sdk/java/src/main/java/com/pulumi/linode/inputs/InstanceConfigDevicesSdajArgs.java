...
public final class InstanceConfigDevicesSdajArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdajArgs Empty = new InstanceConfigDevicesSdajArgs();
    ...
    private InstanceConfigDevicesSdajArgs() {}

    private InstanceConfigDevicesSdajArgs(InstanceConfigDevicesSdajArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdajArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdajArgs();
        }

        public Builder(InstanceConfigDevicesSdajArgs defaults) {
            $ = new InstanceConfigDevicesSdajArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdajArgs build() {
            return $;
        }
    }
