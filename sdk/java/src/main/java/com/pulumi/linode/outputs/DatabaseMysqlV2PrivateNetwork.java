...
@CustomType
public final class DatabaseMysqlV2PrivateNetwork {
    /**
    ...
    private DatabaseMysqlV2PrivateNetwork() {}
    /**
     * @return Set to `true` to allow clients outside of the VPC to connect to the database using a public IP address.
     * 
     */
    ...
    public static Builder builder(DatabaseMysqlV2PrivateNetwork defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vpcId;
        public Builder() {}
        public Builder(DatabaseMysqlV2PrivateNetwork defaults) {
        ...
        public Builder subnetId(Integer subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("DatabaseMysqlV2PrivateNetwork", "subnetId");
            }
        ...
        public Builder vpcId(Integer vpcId) {
            if (vpcId == null) {
              throw new MissingRequiredPropertyException("DatabaseMysqlV2PrivateNetwork", "vpcId");
            }
            this.vpcId = vpcId;
            return this;
        }
        public DatabaseMysqlV2PrivateNetwork build() {
            final var _resultValue = new DatabaseMysqlV2PrivateNetwork();
