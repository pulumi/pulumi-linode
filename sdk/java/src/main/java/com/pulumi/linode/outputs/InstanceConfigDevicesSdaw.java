...
@CustomType
public final class InstanceConfigDevicesSdaw {
    /**
    ...
    private InstanceConfigDevicesSdaw() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdaw defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdaw defaults) {
        ...
        public InstanceConfigDevicesSdaw build() {
            final var _resultValue = new InstanceConfigDevicesSdaw();
