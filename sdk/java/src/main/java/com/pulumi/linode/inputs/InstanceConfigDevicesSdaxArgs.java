...
public final class InstanceConfigDevicesSdaxArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdaxArgs Empty = new InstanceConfigDevicesSdaxArgs();
    ...
    private InstanceConfigDevicesSdaxArgs() {}

    private InstanceConfigDevicesSdaxArgs(InstanceConfigDevicesSdaxArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdaxArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdaxArgs();
        }

        public Builder(InstanceConfigDevicesSdaxArgs defaults) {
            $ = new InstanceConfigDevicesSdaxArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdaxArgs build() {
            return $;
        }
    }
