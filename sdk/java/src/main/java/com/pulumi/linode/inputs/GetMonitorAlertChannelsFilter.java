...
public final class GetMonitorAlertChannelsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetMonitorAlertChannelsFilter Empty = new GetMonitorAlertChannelsFilter();
    ...
    private GetMonitorAlertChannelsFilter() {}

    private GetMonitorAlertChannelsFilter(GetMonitorAlertChannelsFilter $) {
    ...
    public static Builder builder(GetMonitorAlertChannelsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMonitorAlertChannelsFilter();
        }

        public Builder(GetMonitorAlertChannelsFilter defaults) {
            $ = new GetMonitorAlertChannelsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetMonitorAlertChannelsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMonitorAlertChannelsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMonitorAlertChannelsFilter", "values");
            }
            return $;
        }
    }
