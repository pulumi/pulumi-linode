...
public final class GetMonitorLogsDestinationsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMonitorLogsDestinationsFilterArgs Empty = new GetMonitorLogsDestinationsFilterArgs();
    ...
    private GetMonitorLogsDestinationsFilterArgs() {}

    private GetMonitorLogsDestinationsFilterArgs(GetMonitorLogsDestinationsFilterArgs $) {
    ...
    public static Builder builder(GetMonitorLogsDestinationsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMonitorLogsDestinationsFilterArgs();
        }

        public Builder(GetMonitorLogsDestinationsFilterArgs defaults) {
            $ = new GetMonitorLogsDestinationsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMonitorLogsDestinationsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMonitorLogsDestinationsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMonitorLogsDestinationsFilterArgs", "values");
            }
            return $;
        }
    }
