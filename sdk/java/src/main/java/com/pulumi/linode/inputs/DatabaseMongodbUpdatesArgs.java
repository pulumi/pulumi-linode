...
public final class DatabaseMongodbUpdatesArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseMongodbUpdatesArgs Empty = new DatabaseMongodbUpdatesArgs();
    ...
    private DatabaseMongodbUpdatesArgs() {}

    private DatabaseMongodbUpdatesArgs(DatabaseMongodbUpdatesArgs $) {
    ...
    public static Builder builder(DatabaseMongodbUpdatesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseMongodbUpdatesArgs();
        }

        public Builder(DatabaseMongodbUpdatesArgs defaults) {
            $ = new DatabaseMongodbUpdatesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseMongodbUpdatesArgs build() {
