...
import com.pulumi.linode.outputs.GetNbTypesFilter;
import com.pulumi.linode.outputs.GetNbTypesType;
...
@CustomType
public final class GetNbTypesResult {
    ...
    public static Builder builder(GetNbTypesResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetNbTypesResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public GetNbTypesResult build() {
            final var _resultValue = new GetNbTypesResult();
