...
public final class InstanceConfigDevicesSdbcArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbcArgs Empty = new InstanceConfigDevicesSdbcArgs();
    ...
    private InstanceConfigDevicesSdbcArgs() {}

    private InstanceConfigDevicesSdbcArgs(InstanceConfigDevicesSdbcArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbcArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbcArgs();
        }

        public Builder(InstanceConfigDevicesSdbcArgs defaults) {
            $ = new InstanceConfigDevicesSdbcArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbcArgs build() {
            return $;
        }
    }
