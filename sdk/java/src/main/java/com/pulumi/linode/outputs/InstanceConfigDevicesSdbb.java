...
@CustomType
public final class InstanceConfigDevicesSdbb {
    /**
    ...
    private InstanceConfigDevicesSdbb() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbb defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbb defaults) {
        ...
        public InstanceConfigDevicesSdbb build() {
            final var _resultValue = new InstanceConfigDevicesSdbb();
