...
public final class GetPlacementGroupsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetPlacementGroupsFilter Empty = new GetPlacementGroupsFilter();
    ...
    private GetPlacementGroupsFilter() {}

    private GetPlacementGroupsFilter(GetPlacementGroupsFilter $) {
    ...
    public static Builder builder(GetPlacementGroupsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPlacementGroupsFilter();
        }

        public Builder(GetPlacementGroupsFilter defaults) {
            $ = new GetPlacementGroupsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetPlacementGroupsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPlacementGroupsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetPlacementGroupsFilter", "values");
            }
            return $;
        }
    }
