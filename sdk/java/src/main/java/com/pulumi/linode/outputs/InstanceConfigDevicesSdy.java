...
@CustomType
public final class InstanceConfigDevicesSdy {
    /**
    ...
    private InstanceConfigDevicesSdy() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdy defaults) {
        ...
        public InstanceConfigDevicesSdy build() {
            final var _resultValue = new InstanceConfigDevicesSdy();
