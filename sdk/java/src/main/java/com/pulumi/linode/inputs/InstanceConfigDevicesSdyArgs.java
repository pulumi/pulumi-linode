...
public final class InstanceConfigDevicesSdyArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdyArgs Empty = new InstanceConfigDevicesSdyArgs();
    ...
    private InstanceConfigDevicesSdyArgs() {}

    private InstanceConfigDevicesSdyArgs(InstanceConfigDevicesSdyArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdyArgs();
        }

        public Builder(InstanceConfigDevicesSdyArgs defaults) {
            $ = new InstanceConfigDevicesSdyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdyArgs build() {
            return $;
        }
    }
