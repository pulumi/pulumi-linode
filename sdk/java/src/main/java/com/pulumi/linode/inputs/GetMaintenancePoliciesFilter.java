...
public final class GetMaintenancePoliciesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetMaintenancePoliciesFilter Empty = new GetMaintenancePoliciesFilter();
    ...
    private GetMaintenancePoliciesFilter() {}

    private GetMaintenancePoliciesFilter(GetMaintenancePoliciesFilter $) {
    ...
    public static Builder builder(GetMaintenancePoliciesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaintenancePoliciesFilter();
        }

        public Builder(GetMaintenancePoliciesFilter defaults) {
            $ = new GetMaintenancePoliciesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetMaintenancePoliciesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMaintenancePoliciesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMaintenancePoliciesFilter", "values");
            }
            return $;
        }
    }
