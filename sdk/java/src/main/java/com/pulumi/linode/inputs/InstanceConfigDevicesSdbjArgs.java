...
public final class InstanceConfigDevicesSdbjArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdbjArgs Empty = new InstanceConfigDevicesSdbjArgs();
    ...
    private InstanceConfigDevicesSdbjArgs() {}

    private InstanceConfigDevicesSdbjArgs(InstanceConfigDevicesSdbjArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdbjArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdbjArgs();
        }

        public Builder(InstanceConfigDevicesSdbjArgs defaults) {
            $ = new InstanceConfigDevicesSdbjArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdbjArgs build() {
            return $;
        }
    }
