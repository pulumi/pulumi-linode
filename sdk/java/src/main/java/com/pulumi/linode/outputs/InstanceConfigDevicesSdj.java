...
@CustomType
public final class InstanceConfigDevicesSdj {
    /**
    ...
    private InstanceConfigDevicesSdj() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdj defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdj defaults) {
        ...
        public InstanceConfigDevicesSdj build() {
            final var _resultValue = new InstanceConfigDevicesSdj();
