...
public final class GetStackScriptsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetStackScriptsFilterArgs Empty = new GetStackScriptsFilterArgs();
    ...
    private GetStackScriptsFilterArgs() {}

    private GetStackScriptsFilterArgs(GetStackScriptsFilterArgs $) {
    ...
    public static Builder builder(GetStackScriptsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStackScriptsFilterArgs();
        }

        public Builder(GetStackScriptsFilterArgs defaults) {
            $ = new GetStackScriptsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStackScriptsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetStackScriptsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetStackScriptsFilterArgs", "values");
            }
            return $;
        }
    }
