...
public final class InstanceConfigDevicesSdaeArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdaeArgs Empty = new InstanceConfigDevicesSdaeArgs();
    ...
    private InstanceConfigDevicesSdaeArgs() {}

    private InstanceConfigDevicesSdaeArgs(InstanceConfigDevicesSdaeArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdaeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdaeArgs();
        }

        public Builder(InstanceConfigDevicesSdaeArgs defaults) {
            $ = new InstanceConfigDevicesSdaeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdaeArgs build() {
            return $;
        }
    }
