...
public final class InstanceConfigDevicesSdeArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdeArgs Empty = new InstanceConfigDevicesSdeArgs();
    ...
    private InstanceConfigDevicesSdeArgs() {}

    private InstanceConfigDevicesSdeArgs(InstanceConfigDevicesSdeArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdeArgs();
        }

        public Builder(InstanceConfigDevicesSdeArgs defaults) {
            $ = new InstanceConfigDevicesSdeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdeArgs build() {
            return $;
        }
    }
