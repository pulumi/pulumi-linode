...
public final class InstanceConfigDevicesSdtArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdtArgs Empty = new InstanceConfigDevicesSdtArgs();
    ...
    private InstanceConfigDevicesSdtArgs() {}

    private InstanceConfigDevicesSdtArgs(InstanceConfigDevicesSdtArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdtArgs();
        }

        public Builder(InstanceConfigDevicesSdtArgs defaults) {
            $ = new InstanceConfigDevicesSdtArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdtArgs build() {
            return $;
        }
    }
