...
public final class InstanceConfigDevicesSdiArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdiArgs Empty = new InstanceConfigDevicesSdiArgs();
    ...
    private InstanceConfigDevicesSdiArgs() {}

    private InstanceConfigDevicesSdiArgs(InstanceConfigDevicesSdiArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdiArgs();
        }

        public Builder(InstanceConfigDevicesSdiArgs defaults) {
            $ = new InstanceConfigDevicesSdiArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdiArgs build() {
            return $;
        }
    }
