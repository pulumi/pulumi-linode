...
@CustomType
public final class InstanceConfigDevicesSdo {
    /**
    ...
    private InstanceConfigDevicesSdo() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdo defaults) {
        ...
        public InstanceConfigDevicesSdo build() {
            final var _resultValue = new InstanceConfigDevicesSdo();
