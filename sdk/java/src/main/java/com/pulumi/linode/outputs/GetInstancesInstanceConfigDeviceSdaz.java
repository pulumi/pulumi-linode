...
@CustomType
public final class GetInstancesInstanceConfigDeviceSdaz {
    /**
    ...
    private GetInstancesInstanceConfigDeviceSdaz() {}
    /**
     * @return The Disk ID of the associated `diskLabel`, if used
     * 
     */
    ...
    public static Builder builder(GetInstancesInstanceConfigDeviceSdaz defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(GetInstancesInstanceConfigDeviceSdaz defaults) {
        ...
        public Builder diskId(Integer diskId) {
            if (diskId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceConfigDeviceSdaz", "diskId");
            }
            this.diskId = diskId;
            return this;
        }
        ...
        public GetInstancesInstanceConfigDeviceSdaz build() {
            final var _resultValue = new GetInstancesInstanceConfigDeviceSdaz();
