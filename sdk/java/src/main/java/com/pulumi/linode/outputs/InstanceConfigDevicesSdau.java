...
@CustomType
public final class InstanceConfigDevicesSdau {
    /**
    ...
    private InstanceConfigDevicesSdau() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdau defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdau defaults) {
        ...
        public InstanceConfigDevicesSdau build() {
            final var _resultValue = new InstanceConfigDevicesSdau();
