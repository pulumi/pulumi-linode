...
@CustomType
public final class InstanceConfigDevicesSdai {
    /**
    ...
    private InstanceConfigDevicesSdai() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdai defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdai defaults) {
        ...
        public InstanceConfigDevicesSdai build() {
            final var _resultValue = new InstanceConfigDevicesSdai();
