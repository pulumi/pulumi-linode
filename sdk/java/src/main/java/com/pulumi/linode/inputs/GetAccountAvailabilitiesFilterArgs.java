...
public final class GetAccountAvailabilitiesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAccountAvailabilitiesFilterArgs Empty = new GetAccountAvailabilitiesFilterArgs();
    ...
    private GetAccountAvailabilitiesFilterArgs() {}

    private GetAccountAvailabilitiesFilterArgs(GetAccountAvailabilitiesFilterArgs $) {
    ...
    public static Builder builder(GetAccountAvailabilitiesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAccountAvailabilitiesFilterArgs();
        }

        public Builder(GetAccountAvailabilitiesFilterArgs defaults) {
            $ = new GetAccountAvailabilitiesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAccountAvailabilitiesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAccountAvailabilitiesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetAccountAvailabilitiesFilterArgs", "values");
            }
            return $;
        }
    }
