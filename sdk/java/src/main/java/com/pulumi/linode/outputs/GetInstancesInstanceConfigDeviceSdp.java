...
@CustomType
public final class GetInstancesInstanceConfigDeviceSdp {
    /**
    ...
    private GetInstancesInstanceConfigDeviceSdp() {}
    /**
     * @return The Disk ID of the associated `diskLabel`, if used
     * 
     */
    ...
    public static Builder builder(GetInstancesInstanceConfigDeviceSdp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(GetInstancesInstanceConfigDeviceSdp defaults) {
        ...
        public Builder diskId(Integer diskId) {
            if (diskId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceConfigDeviceSdp", "diskId");
            }
            this.diskId = diskId;
            return this;
        }
        ...
        public GetInstancesInstanceConfigDeviceSdp build() {
            final var _resultValue = new GetInstancesInstanceConfigDeviceSdp();
