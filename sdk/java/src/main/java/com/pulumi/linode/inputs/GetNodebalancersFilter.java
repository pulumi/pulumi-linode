...
public final class GetNodebalancersFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetNodebalancersFilter Empty = new GetNodebalancersFilter();
    ...
    private GetNodebalancersFilter() {}

    private GetNodebalancersFilter(GetNodebalancersFilter $) {
    ...
    public static Builder builder(GetNodebalancersFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNodebalancersFilter();
        }

        public Builder(GetNodebalancersFilter defaults) {
            $ = new GetNodebalancersFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetNodebalancersFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNodebalancersFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetNodebalancersFilter", "values");
            }
            return $;
        }
    }
