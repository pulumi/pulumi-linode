...
public final class NodeBalancerFirewallOutboundArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodeBalancerFirewallOutboundArgs Empty = new NodeBalancerFirewallOutboundArgs();
    ...
    private NodeBalancerFirewallOutboundArgs() {}
    ...
    public static Builder builder(NodeBalancerFirewallOutboundArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodeBalancerFirewallOutboundArgs();
        }

        public Builder(NodeBalancerFirewallOutboundArgs defaults) {
            $ = new NodeBalancerFirewallOutboundArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NodeBalancerFirewallOutboundArgs build() {
            ...
            if ($.ipv6s == null) {
                throw new MissingRequiredPropertyException("NodeBalancerFirewallOutboundArgs", "ipv6s");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("NodeBalancerFirewallOutboundArgs", "label");
            }
            if ($.ports == null) {
                throw new MissingRequiredPropertyException("NodeBalancerFirewallOutboundArgs", "ports");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("NodeBalancerFirewallOutboundArgs", "protocol");
            }
            return $;
        }
    }
