...
public final class GetUsersUserImageGrant {
    ...
    public static final class Builder {
        ...
        public Builder id(Integer id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetUsersUserImageGrant", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetUsersUserImageGrant", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder permissions(String permissions) {
            if (permissions == null) {
              throw new MissingRequiredPropertyException("GetUsersUserImageGrant", "permissions");
            }
            this.permissions = permissions;
            return this;
        }
        public GetUsersUserImageGrant build() {
            final var _resultValue = new GetUsersUserImageGrant();
            _resultValue.id = id;
