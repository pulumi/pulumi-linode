...
public final class GetVpcIpsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetVpcIpsFilter Empty = new GetVpcIpsFilter();
    ...
    private GetVpcIpsFilter(GetVpcIpsFilter $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVpcIpsFilter defaults) {
            $ = new GetVpcIpsFilter(Objects.requireNonNull(defaults));
        }
