...
public final class GetUserVpcGrant extends com.pulumi.resources.InvokeArgs {

    public static final GetUserVpcGrant Empty = new GetUserVpcGrant();
    ...
    private GetUserVpcGrant() {}

    private GetUserVpcGrant(GetUserVpcGrant $) {
        this.id = $.id;
        this.label = $.label;
    ...
    public static Builder builder(GetUserVpcGrant defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetUserVpcGrant defaults) {
            $ = new GetUserVpcGrant(Objects.requireNonNull(defaults));
        }
        ...
        public GetUserVpcGrant build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetUserVpcGrant", "id");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("GetUserVpcGrant", "label");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetUserVpcGrant", "permissions");
            }
            return $;
        }
    }
