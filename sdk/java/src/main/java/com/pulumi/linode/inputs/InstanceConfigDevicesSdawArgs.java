...
public final class InstanceConfigDevicesSdawArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdawArgs Empty = new InstanceConfigDevicesSdawArgs();
    ...
    private InstanceConfigDevicesSdawArgs() {}

    private InstanceConfigDevicesSdawArgs(InstanceConfigDevicesSdawArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdawArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdawArgs();
        }

        public Builder(InstanceConfigDevicesSdawArgs defaults) {
            $ = new InstanceConfigDevicesSdawArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdawArgs build() {
            return $;
        }
    }
