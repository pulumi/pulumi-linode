...
public final class GetChildAccountsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetChildAccountsFilter Empty = new GetChildAccountsFilter();
    ...
    private GetChildAccountsFilter() {}

    private GetChildAccountsFilter(GetChildAccountsFilter $) {
    ...
    public static Builder builder(GetChildAccountsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetChildAccountsFilter();
        }

        public Builder(GetChildAccountsFilter defaults) {
            $ = new GetChildAccountsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetChildAccountsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetChildAccountsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetChildAccountsFilter", "values");
            }
            return $;
        }
    }
