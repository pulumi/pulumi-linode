...
public final class GetMaintenancePoliciesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMaintenancePoliciesFilterArgs Empty = new GetMaintenancePoliciesFilterArgs();
    ...
    private GetMaintenancePoliciesFilterArgs() {}

    private GetMaintenancePoliciesFilterArgs(GetMaintenancePoliciesFilterArgs $) {
    ...
    public static Builder builder(GetMaintenancePoliciesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaintenancePoliciesFilterArgs();
        }

        public Builder(GetMaintenancePoliciesFilterArgs defaults) {
            $ = new GetMaintenancePoliciesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMaintenancePoliciesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMaintenancePoliciesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMaintenancePoliciesFilterArgs", "values");
            }
            return $;
        }
    }
