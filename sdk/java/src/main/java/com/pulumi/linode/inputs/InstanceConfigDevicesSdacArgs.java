...
public final class InstanceConfigDevicesSdacArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdacArgs Empty = new InstanceConfigDevicesSdacArgs();
    ...
    private InstanceConfigDevicesSdacArgs() {}

    private InstanceConfigDevicesSdacArgs(InstanceConfigDevicesSdacArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdacArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdacArgs();
        }

        public Builder(InstanceConfigDevicesSdacArgs defaults) {
            $ = new InstanceConfigDevicesSdacArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdacArgs build() {
            return $;
        }
    }
