...
public final class GetDatabaseMysqlResult {
    ...
    private final List<GetDatabaseMysqlUpdate> updates;
    ...
    private GetDatabaseMysqlResult(
        ...
        @CustomType.Parameter("updates") List<GetDatabaseMysqlUpdate> updates,
    ...
    public static final class Builder {
        ...
        public Builder version(String version) {
            ...
            return new GetDatabaseMysqlResult(allowLists, caCert, clusterSize, created, databaseId, encrypted, engine, engineId, hostPrimary, hostSecondary, id, label, region, replicationType, rootPassword, rootUsername, sslConnection, status, type, updated, updates, version);
        }
    }
}
