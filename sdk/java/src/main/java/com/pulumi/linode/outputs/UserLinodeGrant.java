...
public final class UserLinodeGrant {
    ...
    public static final class Builder {
        ...
        public Builder id(Integer id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("UserLinodeGrant", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder permissions(String permissions) {
            if (permissions == null) {
              throw new MissingRequiredPropertyException("UserLinodeGrant", "permissions");
            }
            this.permissions = permissions;
            return this;
        }
        public UserLinodeGrant build() {
            final var _resultValue = new UserLinodeGrant();
            _resultValue.id = id;
