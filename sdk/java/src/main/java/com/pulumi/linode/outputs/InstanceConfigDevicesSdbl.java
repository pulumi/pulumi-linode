...
@CustomType
public final class InstanceConfigDevicesSdbl {
    /**
    ...
    private InstanceConfigDevicesSdbl() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbl defaults) {
        ...
        public InstanceConfigDevicesSdbl build() {
            final var _resultValue = new InstanceConfigDevicesSdbl();
