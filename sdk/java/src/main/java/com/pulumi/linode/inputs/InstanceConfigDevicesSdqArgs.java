...
public final class InstanceConfigDevicesSdqArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdqArgs Empty = new InstanceConfigDevicesSdqArgs();
    ...
    private InstanceConfigDevicesSdqArgs() {}

    private InstanceConfigDevicesSdqArgs(InstanceConfigDevicesSdqArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdqArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdqArgs();
        }

        public Builder(InstanceConfigDevicesSdqArgs defaults) {
            $ = new InstanceConfigDevicesSdqArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdqArgs build() {
            return $;
        }
    }
