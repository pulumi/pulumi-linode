...
public final class GetFirewallTemplatesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetFirewallTemplatesFilter Empty = new GetFirewallTemplatesFilter();
    ...
    private GetFirewallTemplatesFilter() {}

    private GetFirewallTemplatesFilter(GetFirewallTemplatesFilter $) {
    ...
    public static Builder builder(GetFirewallTemplatesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFirewallTemplatesFilter();
        }

        public Builder(GetFirewallTemplatesFilter defaults) {
            $ = new GetFirewallTemplatesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetFirewallTemplatesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetFirewallTemplatesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetFirewallTemplatesFilter", "values");
            }
            return $;
        }
    }
