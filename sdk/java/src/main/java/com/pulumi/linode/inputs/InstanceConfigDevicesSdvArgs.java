...
public final class InstanceConfigDevicesSdvArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdvArgs Empty = new InstanceConfigDevicesSdvArgs();
    ...
    private InstanceConfigDevicesSdvArgs() {}

    private InstanceConfigDevicesSdvArgs(InstanceConfigDevicesSdvArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdvArgs();
        }

        public Builder(InstanceConfigDevicesSdvArgs defaults) {
            $ = new InstanceConfigDevicesSdvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdvArgs build() {
            return $;
        }
    }
