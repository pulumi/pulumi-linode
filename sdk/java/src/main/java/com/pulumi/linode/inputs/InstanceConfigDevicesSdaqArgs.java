...
public final class InstanceConfigDevicesSdaqArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdaqArgs Empty = new InstanceConfigDevicesSdaqArgs();
    ...
    private InstanceConfigDevicesSdaqArgs() {}

    private InstanceConfigDevicesSdaqArgs(InstanceConfigDevicesSdaqArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdaqArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdaqArgs();
        }

        public Builder(InstanceConfigDevicesSdaqArgs defaults) {
            $ = new InstanceConfigDevicesSdaqArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdaqArgs build() {
            return $;
        }
    }
