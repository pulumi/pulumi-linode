...
public final class InstanceConfigDevicesSdpArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdpArgs Empty = new InstanceConfigDevicesSdpArgs();
    ...
    private InstanceConfigDevicesSdpArgs() {}

    private InstanceConfigDevicesSdpArgs(InstanceConfigDevicesSdpArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdpArgs();
        }

        public Builder(InstanceConfigDevicesSdpArgs defaults) {
            $ = new InstanceConfigDevicesSdpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdpArgs build() {
            return $;
        }
    }
