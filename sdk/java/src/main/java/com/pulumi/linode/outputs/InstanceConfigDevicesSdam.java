...
@CustomType
public final class InstanceConfigDevicesSdam {
    /**
    ...
    private InstanceConfigDevicesSdam() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdam defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdam defaults) {
        ...
        public InstanceConfigDevicesSdam build() {
            final var _resultValue = new InstanceConfigDevicesSdam();
