...
public final class InstanceConfigDevicesSdadArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdadArgs Empty = new InstanceConfigDevicesSdadArgs();
    ...
    private InstanceConfigDevicesSdadArgs() {}

    private InstanceConfigDevicesSdadArgs(InstanceConfigDevicesSdadArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdadArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdadArgs();
        }

        public Builder(InstanceConfigDevicesSdadArgs defaults) {
            $ = new InstanceConfigDevicesSdadArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdadArgs build() {
            return $;
        }
    }
