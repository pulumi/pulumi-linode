...
public final class GetLocksFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetLocksFilterArgs Empty = new GetLocksFilterArgs();
    ...
    private GetLocksFilterArgs() {}

    private GetLocksFilterArgs(GetLocksFilterArgs $) {
    ...
    public static Builder builder(GetLocksFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocksFilterArgs();
        }

        public Builder(GetLocksFilterArgs defaults) {
            $ = new GetLocksFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocksFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLocksFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLocksFilterArgs", "values");
            }
            return $;
        }
    }
