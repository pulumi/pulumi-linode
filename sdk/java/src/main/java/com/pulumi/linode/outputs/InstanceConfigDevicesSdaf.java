...
@CustomType
public final class InstanceConfigDevicesSdaf {
    /**
    ...
    private InstanceConfigDevicesSdaf() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdaf defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdaf defaults) {
        ...
        public InstanceConfigDevicesSdaf build() {
            final var _resultValue = new InstanceConfigDevicesSdaf();
