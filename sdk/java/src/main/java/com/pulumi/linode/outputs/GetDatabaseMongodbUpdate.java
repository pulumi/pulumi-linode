...
@CustomType
public final class GetDatabaseMongodbUpdate {
    ...
    private GetDatabaseMongodbUpdate(
    ...
    public static Builder builder(GetDatabaseMongodbUpdate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetDatabaseMongodbUpdate defaults) {
        ...
        public Builder weekOfMonth(Integer weekOfMonth) {
            ...
            return this;
        }        public GetDatabaseMongodbUpdate build() {
            return new GetDatabaseMongodbUpdate(dayOfWeek, duration, frequency, hourOfDay, weekOfMonth);
        }
    }
}
