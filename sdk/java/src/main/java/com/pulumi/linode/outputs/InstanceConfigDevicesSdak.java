...
@CustomType
public final class InstanceConfigDevicesSdak {
    /**
    ...
    private InstanceConfigDevicesSdak() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdak defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdak defaults) {
        ...
        public InstanceConfigDevicesSdak build() {
            final var _resultValue = new InstanceConfigDevicesSdak();
