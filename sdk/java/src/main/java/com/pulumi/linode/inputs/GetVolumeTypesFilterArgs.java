...
public final class GetVolumeTypesFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetVolumeTypesFilterArgs() {}

    private GetVolumeTypesFilterArgs(GetVolumeTypesFilterArgs $) {
    ...
    public static Builder builder(GetVolumeTypesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVolumeTypesFilterArgs();
        }

        public Builder(GetVolumeTypesFilterArgs defaults) {
            $ = new GetVolumeTypesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVolumeTypesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVolumeTypesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVolumeTypesFilterArgs", "values");
            }
            return $;
        }
    }
