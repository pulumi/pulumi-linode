...
public final class UserNodebalancerGrant {
    ...
    public static Builder builder(UserNodebalancerGrant defaults) {
    ...
    public static final class Builder {
        ...
        private String permissions;
        public Builder() {}
        public Builder(UserNodebalancerGrant defaults) {
        ...
        public Builder id(Integer id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("UserNodebalancerGrant", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder permissions(String permissions) {
            if (permissions == null) {
              throw new MissingRequiredPropertyException("UserNodebalancerGrant", "permissions");
            }
