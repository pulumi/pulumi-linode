...
@CustomType
public final class InstanceConfigDevicesSdbf {
    /**
    ...
    private InstanceConfigDevicesSdbf() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdbf defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdbf defaults) {
        ...
        public InstanceConfigDevicesSdbf build() {
            final var _resultValue = new InstanceConfigDevicesSdbf();
