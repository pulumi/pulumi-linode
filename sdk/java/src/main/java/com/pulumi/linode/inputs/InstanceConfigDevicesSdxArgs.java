...
public final class InstanceConfigDevicesSdxArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdxArgs Empty = new InstanceConfigDevicesSdxArgs();
    ...
    private InstanceConfigDevicesSdxArgs() {}

    private InstanceConfigDevicesSdxArgs(InstanceConfigDevicesSdxArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdxArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdxArgs();
        }

        public Builder(InstanceConfigDevicesSdxArgs defaults) {
            $ = new InstanceConfigDevicesSdxArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdxArgs build() {
            return $;
        }
    }
