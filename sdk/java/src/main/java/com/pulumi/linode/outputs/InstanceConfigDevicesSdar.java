...
@CustomType
public final class InstanceConfigDevicesSdar {
    /**
    ...
    private InstanceConfigDevicesSdar() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdar defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdar defaults) {
        ...
        public InstanceConfigDevicesSdar build() {
            final var _resultValue = new InstanceConfigDevicesSdar();
