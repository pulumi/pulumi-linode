...
public class ObjectStorageObject extends com.pulumi.resources.CustomResource {
    ...
    public ObjectStorageObject(java.lang.String name, ObjectStorageObjectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("linode:index/objectStorageObject:ObjectStorageObject", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ObjectStorageObject(java.lang.String name, Output<java.lang.String> id, @Nullable ObjectStorageObjectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("linode:index/objectStorageObject:ObjectStorageObject", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ObjectStorageObject get(java.lang.String name, Output<java.lang.String> id, @Nullable ObjectStorageObjectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
