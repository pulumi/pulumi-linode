...
@CustomType
public final class InstanceDiskTimeouts {
    /**
    ...
    public static Builder builder(InstanceDiskTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(InstanceDiskTimeouts defaults) {
        ...
        public InstanceDiskTimeouts build() {
            final var _resultValue = new InstanceDiskTimeouts();
