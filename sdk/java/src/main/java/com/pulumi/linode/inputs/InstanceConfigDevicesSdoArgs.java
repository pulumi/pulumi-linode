...
public final class InstanceConfigDevicesSdoArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdoArgs Empty = new InstanceConfigDevicesSdoArgs();
    ...
    private InstanceConfigDevicesSdoArgs() {}

    private InstanceConfigDevicesSdoArgs(InstanceConfigDevicesSdoArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdoArgs();
        }

        public Builder(InstanceConfigDevicesSdoArgs defaults) {
            $ = new InstanceConfigDevicesSdoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdoArgs build() {
            return $;
        }
    }
