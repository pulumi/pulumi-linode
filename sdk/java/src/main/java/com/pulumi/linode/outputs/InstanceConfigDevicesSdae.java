...
@CustomType
public final class InstanceConfigDevicesSdae {
    /**
    ...
    private InstanceConfigDevicesSdae() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdae defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdae defaults) {
        ...
        public InstanceConfigDevicesSdae build() {
            final var _resultValue = new InstanceConfigDevicesSdae();
