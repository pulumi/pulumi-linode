...
@CustomType
public final class InstanceConfigDevicesSdw {
    /**
    ...
    private InstanceConfigDevicesSdw() {}
    /**
     * @return The Disk ID to map to this disk slot
     * 
     */
    ...
    public static Builder builder(InstanceConfigDevicesSdw defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer volumeId;
        public Builder() {}
        public Builder(InstanceConfigDevicesSdw defaults) {
        ...
        public InstanceConfigDevicesSdw build() {
            final var _resultValue = new InstanceConfigDevicesSdw();
