...
public final class InstanceConfigDevicesSdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdsArgs Empty = new InstanceConfigDevicesSdsArgs();
    ...
    private InstanceConfigDevicesSdsArgs() {}

    private InstanceConfigDevicesSdsArgs(InstanceConfigDevicesSdsArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdsArgs();
        }

        public Builder(InstanceConfigDevicesSdsArgs defaults) {
            $ = new InstanceConfigDevicesSdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdsArgs build() {
            return $;
        }
    }
