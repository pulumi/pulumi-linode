...
public final class InstanceConfigDevicesSdzArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigDevicesSdzArgs Empty = new InstanceConfigDevicesSdzArgs();
    ...
    private InstanceConfigDevicesSdzArgs() {}

    private InstanceConfigDevicesSdzArgs(InstanceConfigDevicesSdzArgs $) {
        this.diskId = $.diskId;
    ...
    public static Builder builder(InstanceConfigDevicesSdzArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigDevicesSdzArgs();
        }

        public Builder(InstanceConfigDevicesSdzArgs defaults) {
            $ = new InstanceConfigDevicesSdzArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigDevicesSdzArgs build() {
            return $;
        }
    }
