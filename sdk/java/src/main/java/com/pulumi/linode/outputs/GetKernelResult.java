    ...
    public static final class Builder {
        ...
        public Builder architecture(String architecture) {
            if (architecture == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "architecture");
            }
        ...
        public Builder built(String built) {
            if (built == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "built");
            }
            this.built = built;
            return this;
        }
        ...
        public Builder deprecated(Boolean deprecated) {
            if (deprecated == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "deprecated");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder kvm(Boolean kvm) {
            if (kvm == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "kvm");
            }
            this.kvm = kvm;
            return this;
        }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder pvops(Boolean pvops) {
            if (pvops == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "pvops");
            }
            this.pvops = pvops;
            return this;
        }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetKernelResult", "version");
            }
