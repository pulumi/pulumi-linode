...
namespace Pulumi.Linode.Inputs
{
    ...
    public sealed class MonitorLogsDestinationCustomHttpsDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication configuration for the HTTPS endpoint.
        /// </summary>
        [Input("authentication", required: true)]
        public Input<Inputs.MonitorLogsDestinationCustomHttpsDetailsAuthenticationArgs> Authentication { get; set; } = null!;

        /// <summary>
        /// TLS client certificate configuration.
        /// </summary>
        [Input("clientCertificateDetails")]
        public Input<Inputs.MonitorLogsDestinationCustomHttpsDetailsClientCertificateDetailsArgs>? ClientCertificateDetails { get; set; }
        ...
        [Input("customHeaders")]
        private InputList<Inputs.MonitorLogsDestinationCustomHttpsDetailsCustomHeaderArgs>? _customHeaders;

        /// <summary>
        /// Custom HTTP headers to include in log delivery requests.
        /// </summary>
        public InputList<Inputs.MonitorLogsDestinationCustomHttpsDetailsCustomHeaderArgs> CustomHeaders
        {
            get => _customHeaders ?? (_customHeaders = new InputList<Inputs.MonitorLogsDestinationCustomHttpsDetailsCustomHeaderArgs>());
        ...
        public MonitorLogsDestinationCustomHttpsDetailsArgs()
        {
        }
        public static new MonitorLogsDestinationCustomHttpsDetailsArgs Empty => new MonitorLogsDestinationCustomHttpsDetailsArgs();
    }
}
