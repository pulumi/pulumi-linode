...
namespace Pulumi.Linode.Inputs
{
    ...
    public sealed class VpcSubnetDatabaseGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _ipv6Ranges ?? (_ipv6Ranges = new InputList<Inputs.VpcSubnetDatabaseIpv6RangeGetArgs>());
            set => _ipv6Ranges = value;
        }

        public VpcSubnetDatabaseGetArgs()
        {
        }
        public static new VpcSubnetDatabaseGetArgs Empty => new VpcSubnetDatabaseGetArgs();
    }
}
