...
namespace Pulumi.Linode.Outputs
{
    ...
    [OutputType]
    public sealed class InstanceInterfaceIpv6
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.InstanceInterfaceIpv6Range> Ranges;
        /// <summary>
        /// An array of SLAAC prefixes to use for this interface.
        /// </summary>
        public readonly ImmutableArray<Outputs.InstanceInterfaceIpv6Slaac> Slaacs;

        [OutputConstructor]
        private InstanceInterfaceIpv6(
            bool? isPublic,

            ImmutableArray<Outputs.InstanceInterfaceIpv6Range> ranges,

            ImmutableArray<Outputs.InstanceInterfaceIpv6Slaac> slaacs)
        {
            IsPublic = isPublic;
            Ranges = ranges;
            Slaacs = slaacs;
