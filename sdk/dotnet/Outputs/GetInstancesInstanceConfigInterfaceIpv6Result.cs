...
namespace Pulumi.Linode.Outputs
{
    ...
    public sealed class GetInstancesInstanceConfigInterfaceIpv6Result
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetInstancesInstanceConfigInterfaceIpv6SlaacResult> Slaacs;

        [OutputConstructor]
        private GetInstancesInstanceConfigInterfaceIpv6Result(
            bool isPublic,

            ImmutableArray<Outputs.GetInstancesInstanceConfigInterfaceIpv6RangeResult> ranges,

            ImmutableArray<Outputs.GetInstancesInstanceConfigInterfaceIpv6SlaacResult> slaacs)
        {
            IsPublic = isPublic;
            Ranges = ranges;
            Slaacs = slaacs;
