...
class InstancePlacementGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int id: The ID of the Placement Group.
        :param str label: The Linode's label is for display purposes only. If no label is provided for a Linode, a default will be assigned.
        :param str placement_group_policy: Whether the Placement Group enforces strict compliance.
        :param str placement_group_type: The placement group type enforced by the Placement Group.
        """
        pulumi.set(__self__, "id", id)
    ...
    def placement_group_policy(self) -> Optional[str]:
        """
    ...
    def placement_group_type(self) -> Optional[str]:
        """
...
class LkeClusterPoolTaint(dict):
    def __init__(__self__, *,
                 ...
                 value: str):
        """
        :param str effect: The Kubernetes taint effect.
...
class LkeNodePoolTaint(dict):
    def __init__(__self__, *,
                 ...
                 value: str):
        """
        :param str effect: The Kubernetes taint effect. Accepted values are `NoSchedule`, `PreferNoSchedule`, and `NoExecute`. For the descriptions of these values, see [Kubernetes Taints and Tolerations](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/).
        :param str key: The Kubernetes taint key.
        :param str value: The Kubernetes taint value.
        """
        pulumi.set(__self__, "effect", effect)
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[str] capabilities: A list of capabilities of this Linode instance.
