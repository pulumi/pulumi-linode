...
class GetDomainResult(object):
    ...
    """
    def __init__(__self__, axfr_ips=None, description=None, expire_sec=None, group=None, master_ips=None, refresh_sec=None, retry_sec=None, soa_email=None, status=None, tags=None, ttl_sec=None, type=None):
...
async def get_domain(domain=None, id=None):
    """
    ...
    * `tags` - An array of tags applied to this object.
    ...
    __args__['id'] = id
    __ret__ = await pulumi.runtime.invoke('linode:index/getDomain:getDomain', __args__)
