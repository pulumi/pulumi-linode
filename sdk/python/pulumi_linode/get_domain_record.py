...
class GetDomainRecordResult:
    ...
    def domain_id(self) -> builtins.int:
        """
...
def get_domain_record(domain_id: Optional[builtins.int] = None,
    ...
    :param builtins.int domain_id: The associated domain's unique ID.
    :param builtins.int id: The unique ID of the Domain Record.
...
def get_domain_record_output(domain_id: Optional[pulumi.Input[builtins.int]] = None,
