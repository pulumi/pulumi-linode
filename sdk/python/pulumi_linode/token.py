...
class TokenArgs:
    def __init__(__self__, *,
                 scopes: pulumi.Input[builtins.str],
                 expiry: Optional[pulumi.Input[builtins.str]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Token resource.
        :param pulumi.Input[builtins.str] scopes: The scopes this token was created with. These define what parts of the Account the token can be used to access. Many command-line tools, such as the Linode CLI, require tokens with access to *. Tokens with more restrictive scopes are generally more secure. All scopes can be viewed in [the Linode API documentation](https://techdocs.akamai.com/linode-api/reference/get-started#oauth-reference).
        :param pulumi.Input[builtins.str] expiry: When this token will expire. Personal Access Tokens cannot be renewed, so after this time the token will be completely unusable and a new token will need to be generated. Tokens may be created with 'null' as their expiry and will never expire unless revoked.
        :param pulumi.Input[builtins.str] label: A label for the Token.
        """
    ...
    @property
    @pulumi.getter
    def scopes(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @scopes.setter
    def scopes(self, value: pulumi.Input[builtins.str]):
...
class _TokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created: The date this Token was created.
        :param pulumi.Input[builtins.str] expiry: When this token will expire. Personal Access Tokens cannot be renewed, so after this time the token will be completely unusable and a new token will need to be generated. Tokens may be created with 'null' as their expiry and will never expire unless revoked.
        :param pulumi.Input[builtins.str] label: A label for the Token.
        :param pulumi.Input[builtins.str] scopes: The scopes this token was created with. These define what parts of the Account the token can be used to access. Many command-line tools, such as the Linode CLI, require tokens with access to *. Tokens with more restrictive scopes are generally more secure. All scopes can be viewed in [the Linode API documentation](https://techdocs.akamai.com/linode-api/reference/get-started#oauth-reference).
        :param pulumi.Input[builtins.str] token: The token used to access the API.
        """
...
class Token(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            label: Optional[pulumi.Input[builtins.str]] = None,
            scopes: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None) -> 'Token':
        """
    ...
    @property
    @pulumi.getter
    def scopes(self) -> pulumi.Output[builtins.str]:
        """
        The scopes this token was created with. These define what parts of the Account the token can be used to access. Many command-line tools, such as the Linode CLI, require tokens with access to *. Tokens with more restrictive scopes are generally more secure. All scopes can be viewed in [the Linode API documentation](https://techdocs.akamai.com/linode-api/reference/get-started#oauth-reference).
        """
        return pulumi.get(self, "scopes")
