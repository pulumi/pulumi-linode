...
class DatabaseMysqlV2PendingUpdateArgs:
    ...
    def planned_for(self) -> pulumi.Input[str]:
        return pulumi.get(self, "planned_for")

    @planned_for.setter
    def planned_for(self, value: pulumi.Input[str]):
...
if not MYPY:
    class InstanceSpecsArgsDict(TypedDict):
        accelerated_devices: NotRequired[pulumi.Input[int]]
        """
...
class InstanceSpecsArgs:
    def __init__(__self__, *,
                 accelerated_devices: Optional[pulumi.Input[int]] = None,
        ...
        """
        :param pulumi.Input[int] accelerated_devices: The number of VPUs this Linode has access to.
        ...
        :param pulumi.Input[int] gpus: The number of GPUs this Linode has access to.
    ...
    def accelerated_devices(self) -> Optional[pulumi.Input[int]]:
        """
        The number of VPUs this Linode has access to.
        """
    ...
    def accelerated_devices(self, value: Optional[pulumi.Input[int]]):
...
class NetworkingIpAssignmentAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 linode_id: pulumi.Input[int]):
        """
        :param pulumi.Input[str] address: The IPv4 address or IPv6 range to assign.
        :param pulumi.Input[int] linode_id: The ID of the Linode to which the IP address will be assigned.
        """
        pulumi.set(__self__, "address", address)
...
if not MYPY:
    class UserGlobalGrantsArgsDict(TypedDict):
        ...
        """
        add_placement_groups: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        add_vpcs: NotRequired[pulumi.Input[bool]]
        """
...
class UserGlobalGrantsArgs:
    def __init__(__self__, *,
                 ...
                 add_placement_groups: Optional[pulumi.Input[bool]] = None,
                 add_stackscripts: Optional[pulumi.Input[bool]] = None,
                 add_volumes: Optional[pulumi.Input[bool]] = None,
                 add_vpcs: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] add_placement_groups: If true, this User may add Placement Groups.
        ...
        :param pulumi.Input[bool] add_vpcs: If true, this User may add Virtual Private Clouds (VPCs).
    ...
    def add_placement_groups(self) -> Optional[pulumi.Input[bool]]:
        """
        If true, this User may add Placement Groups.
        """
    ...
    def add_placement_groups(self, value: Optional[pulumi.Input[bool]]):
    ...
    def add_vpcs(self) -> Optional[pulumi.Input[bool]]:
        """
        If true, this User may add Virtual Private Clouds (VPCs).
        """
    ...
    @add_vpcs.setter
    def add_vpcs(self, value: Optional[pulumi.Input[bool]]):
...
class GetInstanceTypesTypeArgs:
    ...
    @accelerated_devices.setter
    def accelerated_devices(self, value: int):
        pulumi.set(self, "accelerated_devices", value)
...
class GetObjectStorageEndpointsEndpointArgs:
    ...
    @s3_endpoint.setter
    def s3_endpoint(self, value: str):
        pulumi.set(self, "s3_endpoint", value)
...
class GetUsersUserGlobalGrantArgs:
    ...
    @add_placement_groups.setter
    def add_placement_groups(self, value: bool):
        pulumi.set(self, "add_placement_groups", value)
