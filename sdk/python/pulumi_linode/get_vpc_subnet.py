...
def get_vpc_subnet(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The unique id of this VPC subnet.
    :param builtins.int vpc_id: The id of the parent VPC for this VPC Subnet.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_vpc_subnet_output(id: Optional[pulumi.Input[builtins.str]] = None,
