...
def get_database_mysql(database_id: Optional[builtins.int] = None,
    ...
    * `week_of_month` - The week of the month to perform monthly frequency updates. Required for `monthly` frequency updates. (`1`..`4`)
    ...
    :param builtins.int database_id: The ID of the MySQL database. Deprecated: Use id instead.
    :param builtins.int id: The ID of the MySQL database. Mutually exclusive with `database_id`.
    """
    __args__ = dict()
...
def get_database_mysql_output(database_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
