...
class FirewallDeviceInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] entity_id: The unique ID of the entity to attach.
        :param pulumi.Input[builtins.int] firewall_id: The unique ID of the target Firewall.
        :param pulumi.Input[builtins.str] entity_type: The type of the entity to attach. (default: `linode`)
        """
...
class _FirewallDeviceState:
    def __init__(__self__, *,
                 ...
                 entity_id: Optional[pulumi.Input[builtins.int]] = None,
                 entity_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] created: When the Firewall Device was last created.
        :param pulumi.Input[builtins.int] entity_id: The unique ID of the entity to attach.
        :param pulumi.Input[builtins.str] entity_type: The type of the entity to attach. (default: `linode`)
        :param pulumi.Input[builtins.int] firewall_id: The unique ID of the target Firewall.
        :param pulumi.Input[builtins.str] updated: When the Firewall Device was last updated.
        """
    ...
    @property
    @pulumi.getter(name="entityId")
    def entity_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The unique ID of the entity to attach.
        """
        return pulumi.get(self, "entity_id")
    ...
    @entity_id.setter
    def entity_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "entity_id", value)
...
class FirewallDevice(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entity_type: Optional[pulumi.Input[builtins.str]] = None,
            firewall_id: Optional[pulumi.Input[builtins.int]] = None,
            updated: Optional[pulumi.Input[builtins.str]] = None) -> 'FirewallDevice':
        """
    ...
    @property
    @pulumi.getter(name="entityId")
    def entity_id(self) -> pulumi.Output[builtins.int]:
        """
        The unique ID of the entity to attach.
        """
        return pulumi.get(self, "entity_id")
