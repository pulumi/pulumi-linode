...
class AccountSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] backups_enabled: Account-wide backups default.
        :param pulumi.Input[str] longview_subscription: The Longview Pro tier you are currently subscribed to.
