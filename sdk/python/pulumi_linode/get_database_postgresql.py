...
class GetDatabasePostgresqlResult:
    ...
    def database_id(self) -> Optional[builtins.int]:
    ...
    def replication_commit_type(self) -> builtins.str:
        """
...
def get_database_postgresql(database_id: Optional[builtins.int] = None,
    ...
    * `week_of_month` - The week of the month to perform monthly frequency updates. Required for `monthly` frequency updates. (`1`..`4`)
    ...
    :param builtins.int database_id: The ID of the PostgreSQL database. Deprecated: Use id instead.
    :param builtins.int id: The ID of the PostgreSQL database. Mutually exclusive with `database_id`.
    """
    __args__ = dict()
...
def get_database_postgresql_output(database_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
