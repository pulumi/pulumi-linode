...
class GetDomainZonefileResult:
    ...
    def zone_files(self) -> Sequence[builtins.str]:
        """
...
def get_domain_zonefile(domain_id: Optional[builtins.int] = None,
...
def get_domain_zonefile_output(domain_id: Optional[pulumi.Input[builtins.int]] = None,
