...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 placement_group_externally_managed: Optional[pulumi.Input[builtins.bool]] = None,
                 private_ip: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorized_users: A list of Linode usernames. If the usernames have associated SSH keys, the keys will be appended to the `root` user's
               `~/.ssh/authorized_keys` file automatically. Only accepted if 'image' is provided.
        :param pulumi.Input[builtins.int] backup_id: A Backup ID from another Linode's available backups. Your User must have read_write access to that Linode, the Backup
        ...
        :param pulumi.Input[builtins.str] disk_encryption: The disk encryption policy for this instance. (`enabled`, `disabled`; default `enabled` in supported regions)
               
               * **NOTE: Disk encryption may not currently be available to all users.**
        :param pulumi.Input[builtins.int] firewall_id: The ID of the Firewall to attach to the instance upon creation. *Changing `firewall_id` forces the creation of a new Linode Instance.*
        :param pulumi.Input[builtins.str] group: A deprecated property denoting a group label for this Linode. We recommend using the `tags` attribute instead.
        ...
        :param pulumi.Input[builtins.str] migration_type: The type of migration to use when updating the type or region of a Linode. (`cold`, `warm`; default `cold`)
        ...
        :param pulumi.Input[builtins.bool] placement_group_externally_managed: If true, changes to the Linode's assigned Placement Group will be ignored. This is necessary when using this resource in conjunction with the PlacementGroupAssignment resource.
        :param pulumi.Input[builtins.bool] private_ip: If true, the created Linode will have private networking enabled, allowing use of the 192.168.128.0/17 network within the Linode's region. It can be enabled on an existing Linode but it can't be disabled.
        :param pulumi.Input[builtins.bool] resize_disk: If true, changes in Linode type will attempt to upsize or downsize implicitly created disks. This must be false if explicit disks are defined. *This is an irreversible action as Linode disks cannot be automatically downsized.*
        ...
        :param pulumi.Input[builtins.str] root_pass: The password that will be initially assigned to the 'root' user account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] shared_ipv4s: A set of IPv4 addresses to be shared with the Instance. These IP addresses can be both private and public, but must be in the same region as the instance.
        ...
        :param pulumi.Input[builtins.int] swap_size: When deploying from an Image, this field is optional with a Linode API default of 512mb, otherwise it is ignored. This
        ...
        :param pulumi.Input[builtins.str] type: The Linode type defines the pricing, CPU, disk, and RAM specs of the instance. Examples are `"g6-nanode-1"`, `"g6-standard-2"`, `"g6-highmem-16"`, `"g6-dedicated-16"`, etc. See all types [here](https://api.linode.com/v4/linode/types).
               
               - - -
        :param pulumi.Input[builtins.bool] watchdog_enabled: The watchdog, named Lassie, is a Shutdown Watchdog that monitors your Linode and will reboot it if it powers off unexpectedly. It works by issuing a boot job when your Linode powers off without a shutdown job being responsible. To prevent a loop, Lassie will give up if there have been more than 5 boot jobs issued within 15 minutes.
        """
    ...
    def backup_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @backup_id.setter
    def backup_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def boot_config_label(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def boot_config_label(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def placement_group_externally_managed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def placement_group_externally_managed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "placement_group_externally_managed", value)

    @property
    @pulumi.getter(name="privateIp")
    def private_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @private_ip.setter
    def private_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def shared_ipv4s(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @shared_ipv4s.setter
    def shared_ipv4s(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def swap_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @swap_size.setter
    def swap_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def watchdog_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def watchdog_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 firewall_id: Optional[pulumi.Input[builtins.int]] = None,
                 group: Optional[pulumi.Input[builtins.str]] = None,
                 has_user_data: Optional[pulumi.Input[builtins.bool]] = None,
                 host_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 image: Optional[pulumi.Input[builtins.str]] = None,
                 interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceInterfaceArgs']]]] = None,
                 ...
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 lke_cluster_id: Optional[pulumi.Input[builtins.int]] = None,
                 metadatas: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceMetadataArgs']]]] = None,
                 migration_type: Optional[pulumi.Input[builtins.str]] = None,
                 placement_group: Optional[pulumi.Input['InstancePlacementGroupArgs']] = None,
                 placement_group_externally_managed: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] boot_config_label: The Label of the Instance Config that should be used to boot the Linode instance.
        :param pulumi.Input[builtins.bool] booted: If true, then the instance is kept or converted into in a running state. If false, the instance will be shutdown. If unspecified, the Linode's power status will not be managed by the Provider.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] capabilities: A list of capabilities of this Linode instance.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceConfigArgs']]] configs: Configuration profiles define the VM settings and boot behavior of the Linode Instance.
        :param pulumi.Input[builtins.str] disk_encryption: The disk encryption policy for this instance. (`enabled`, `disabled`; default `enabled` in supported regions)
        ...
        :param pulumi.Input[builtins.int] firewall_id: The ID of the Firewall to attach to the instance upon creation. *Changing `firewall_id` forces the creation of a new Linode Instance.*
        :param pulumi.Input[builtins.str] group: A deprecated property denoting a group label for this Linode. We recommend using the `tags` attribute instead.
        :param pulumi.Input[builtins.bool] has_user_data: Whether this Instance was created with user-data.
        :param pulumi.Input[builtins.str] host_uuid: The Linode’s host machine, as a UUID.
        :param pulumi.Input[builtins.str] image: An Image ID to deploy the Disk from. Official Linode Images start with linode/, while your Images start with private/.
               See /images for more information on the Images available for you to use.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceInterfaceArgs']]] interfaces: An array of Network Interfaces for this Linode to be created with. If an explicit config or disk is defined, interfaces
               must be declared in the config block.
        :param pulumi.Input[builtins.str] ip_address: A string containing the Linode's public IP address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv4s: A set of reserved IPv4 addresses to assign to this Linode on creation.
        ...
        :param pulumi.Input[builtins.bool] placement_group_externally_managed: If true, changes to the Linode's assigned Placement Group will be ignored. This is necessary when using this resource in conjunction with the PlacementGroupAssignment resource.
        :param pulumi.Input[builtins.bool] private_ip: If true, the created Linode will have private networking enabled, allowing use of the 192.168.128.0/17 network within the Linode's region. It can be enabled on an existing Linode but it can't be disabled.
        :param pulumi.Input[builtins.str] private_ip_address: This Linode's Private IPv4 Address, if enabled.  The regional private IP address range, 192.168.128.0/17, is shared by all Linode Instances in a region.
        :param pulumi.Input[builtins.str] region: This is the location where the Linode is deployed. Examples are `"us-east"`, `"us-west"`, `"ap-south"`, etc. See all regions [here](https://api.linode.com/v4/regions). *Changing `region` will trigger a migration of this Linode. Migration operations are typically long-running operations, so the update timeout should be adjusted accordingly.*.
        :param pulumi.Input[builtins.bool] resize_disk: If true, changes in Linode type will attempt to upsize or downsize implicitly created disks. This must be false if explicit disks are defined. *This is an irreversible action as Linode disks cannot be automatically downsized.*
        ...
        :param pulumi.Input[builtins.int] stackscript_id: The StackScript to deploy to the newly created Linode. If provided, 'image' must also be provided, and must be an Image
               that is compatible with this StackScript.
        :param pulumi.Input[builtins.str] status: The status of the instance, indicating the current readiness state. (`running`, `offline`, ...)
        :param pulumi.Input[builtins.int] swap_size: When deploying from an Image, this field is optional with a Linode API default of 512mb, otherwise it is ignored. This
               is used to set the swap disk size for the newly-created Linode.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags applied to this object. Tags are case-insensitive and are for organizational purposes only.
        :param pulumi.Input[builtins.str] type: The Linode type defines the pricing, CPU, disk, and RAM specs of the instance. Examples are `"g6-nanode-1"`, `"g6-standard-2"`, `"g6-highmem-16"`, `"g6-dedicated-16"`, etc. See all types [here](https://api.linode.com/v4/linode/types).
    ...
    def has_user_data(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_user_data(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_user_data", value)

    @property
    @pulumi.getter(name="hostUuid")
    def host_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @host_uuid.setter
    def host_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def lke_cluster_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def lke_cluster_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            watchdog_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="backupId")
    def backup_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        A Backup ID from another Linode's available backups. Your User must have read_write access to that Linode, the Backup
        must have a status of successful, and the Linode must be deployed to the same region as the Backup. See
        /linode/instances/{linodeId}/backups for a Linode's available backups. This field and the image field are mutually
    ...
    @property
    @pulumi.getter(name="bootConfigLabel")
    def boot_config_label(self) -> pulumi.Output[builtins.str]:
        """
        The Label of the Instance Config that should be used to boot the Linode instance.
        """
        return pulumi.get(self, "boot_config_label")
    ...
    @property
    @pulumi.getter(name="hasUserData")
    def has_user_data(self) -> pulumi.Output[builtins.bool]:
        """
        Whether this Instance was created with user-data.
        """
        return pulumi.get(self, "has_user_data")
    ...
    @property
    @pulumi.getter(name="hostUuid")
    def host_uuid(self) -> pulumi.Output[builtins.str]:
        """
        The Linode’s host machine, as a UUID.
        """
        return pulumi.get(self, "host_uuid")
    ...
    @property
    @pulumi.getter
    def ipv4s(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A set of reserved IPv4 addresses to assign to this Linode on creation.
    ...
    @property
    @pulumi.getter(name="lkeClusterId")
    def lke_cluster_id(self) -> pulumi.Output[builtins.int]:
        """
        If applicable, the ID of the LKE cluster this instance is a part of.
        """
        return pulumi.get(self, "lke_cluster_id")
    ...
    @property
    @pulumi.getter(name="placementGroupExternallyManaged")
    def placement_group_externally_managed(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, changes to the Linode's assigned Placement Group will be ignored. This is necessary when using this resource in conjunction with the PlacementGroupAssignment resource.
        """
        return pulumi.get(self, "placement_group_externally_managed")
    ...
    @property
    @pulumi.getter(name="privateIp")
    def private_ip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, the created Linode will have private networking enabled, allowing use of the 192.168.128.0/17 network within the Linode's region. It can be enabled on an existing Linode but it can't be disabled.
        """
        return pulumi.get(self, "private_ip")
    ...
    @property
    @pulumi.getter(name="sharedIpv4s")
    def shared_ipv4s(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A set of IPv4 addresses to be shared with the Instance. These IP addresses can be both private and public, but must be in the same region as the instance.
    ...
    @property
    @pulumi.getter(name="swapSize")
    def swap_size(self) -> pulumi.Output[builtins.int]:
        """
        When deploying from an Image, this field is optional with a Linode API default of 512mb, otherwise it is ignored. This
        is used to set the swap disk size for the newly-created Linode.
        """
    ...
    @property
    @pulumi.getter(name="watchdogEnabled")
    def watchdog_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The watchdog, named Lassie, is a Shutdown Watchdog that monitors your Linode and will reboot it if it powers off unexpectedly. It works by issuing a boot job when your Linode powers off without a shutdown job being responsible. To prevent a loop, Lassie will give up if there have been more than 5 boot jobs issued within 15 minutes.
        """
        return pulumi.get(self, "watchdog_enabled")
