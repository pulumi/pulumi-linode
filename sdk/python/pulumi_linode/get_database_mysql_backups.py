...
class GetDatabaseMysqlBackupsResult:
    ...
    def database_id(self) -> builtins.int:
...
def get_database_mysql_backups(database_id: Optional[builtins.int] = None,
...
def get_database_mysql_backups_output(database_id: Optional[pulumi.Input[builtins.int]] = None,
