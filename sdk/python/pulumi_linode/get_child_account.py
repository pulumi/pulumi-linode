...
def get_child_account(euuid: Optional[builtins.str] = None,
    ...
    **NOTE: Parent/Child related features may not be generally available.**
    ...
    :param builtins.str euuid: The unique EUUID of this Child Account.
    """
    __args__ = dict()
...
def get_child_account_output(euuid: Optional[pulumi.Input[builtins.str]] = None,
