...
def get_linode_object_storage_bucket(cluster: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster: The ID of the Object Storage Cluster this bucket is in. Required if `region` is not configured.
    :param builtins.str label: The name of this bucket.
    :param builtins.str region: The ID of the region this bucket is in. Required if `cluster` is not configured.
    """
    __args__ = dict()
...
def get_linode_object_storage_bucket_output(cluster: Optional[pulumi.Input[Optional[builtins.str]]] = None,
