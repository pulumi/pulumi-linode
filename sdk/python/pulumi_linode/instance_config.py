...
class InstanceConfigInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] label: The name of this interface.
        ...
        :param pulumi.Input[str] kernel: A Kernel ID to boot a Linode with. (default `linode/latest-64bit`)
...
class InstanceConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 booted: Optional[pulumi.Input[bool]] = None,
                 comments: Optional[pulumi.Input[str]] = None,
                 devices: Optional[pulumi.Input[pulumi.InputType['InstanceConfigDevicesArgs']]] = None,
                 helpers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceConfigHelperArgs']]]]] = None,
                 interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceConfigInterfaceArgs']]]]] = None,
                 kernel: Optional[pulumi.Input[str]] = None,
                 label: Optional[pulumi.Input[str]] = None,
                 linode_id: Optional[pulumi.Input[int]] = None,
                 memory_limit: Optional[pulumi.Input[int]] = None,
        ...
        **NOTE:** Deleting a config will shut down the attached instance if the config is in use.
        ...
        boot = linode.InstanceDisk("boot",
            label="boot",
            linode_id=my_instance.id,
            size=my_instance.specs.apply(lambda specs: specs.disk - 512),
            image="linode/ubuntu20.04",
            root_pass="myc00lpass!")
        # Create a swap disk
        ...
        :param pulumi.Input[bool] booted: If true, the Linode will be booted into this config. If another config is booted, the Linode will be rebooted into this config. If false, the Linode will be shutdown only if it is currently booted into this config. If undefined, the config will alter the boot status of the Linode.
        :param pulumi.Input[str] comments: Optional field for arbitrary User comments on this Config.
        :param pulumi.Input[pulumi.InputType['InstanceConfigDevicesArgs']] devices: A dictionary of device disks to use as a device map in a Linode’s configuration profile.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceConfigHelperArgs']]]] helpers: Helpers enabled when booting to this Linode Config.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceConfigInterfaceArgs']]]] interfaces: An array of Network Interfaces to add to this Linode’s Configuration Profile.
        :param pulumi.Input[str] kernel: A Kernel ID to boot a Linode with. (default `linode/latest-64bit`)
        :param pulumi.Input[str] label: The name of this interface.
        :param pulumi.Input[int] linode_id: The ID of the Linode to create this configuration profile under.
        :param pulumi.Input[int] memory_limit: The memory limit of the Config. Defaults to the total ram of the Linode.
