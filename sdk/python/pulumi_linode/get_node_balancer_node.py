...
def get_node_balancer_node(config_id: Optional[builtins.int] = None,
    ...
    :param builtins.int config_id: The ID of the config that contains the Node.
    :param builtins.int id: The node's ID.
    :param builtins.int nodebalancer_id: The ID of the NodeBalancer that contains the node.
    """
    __args__ = dict()
...
def get_node_balancer_node_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
