...
//			_, err := linode.GetImage(ctx, &linode.LookupImageArgs{
//				Id: "linode/debian12",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupImageOutput(ctx *pulumi.Context, args LookupImageOutputArgs, opts ...pulumi.InvokeOption) LookupImageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupImageResultOutput, error) {
			...
			return ctx.InvokeOutput("linode:index/getImage:getImage", args, LookupImageResultOutput{}, options).(LookupImageResultOutput), nil
