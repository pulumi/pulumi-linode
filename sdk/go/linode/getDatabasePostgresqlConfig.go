...
func GetDatabasePostgresqlConfig(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetDatabasePostgresqlConfigResult, error) {
	opts = internal.PkgInvokeDefaultOpts(opts)
	var rv GetDatabasePostgresqlConfigResult
	err := ctx.Invoke("linode:index/getDatabasePostgresqlConfig:getDatabasePostgresqlConfig", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatabasePostgresqlConfigResult struct {
	Id                       string                                               `pulumi:"id"`
	PgStatMonitorEnables     []GetDatabasePostgresqlConfigPgStatMonitorEnable     `pulumi:"pgStatMonitorEnables"`
	Pglookouts               []GetDatabasePostgresqlConfigPglookout               `pulumi:"pglookouts"`
	SharedBuffersPercentages []GetDatabasePostgresqlConfigSharedBuffersPercentage `pulumi:"sharedBuffersPercentages"`
	WorkMems                 []GetDatabasePostgresqlConfigWorkMem                 `pulumi:"workMems"`
}
...
// A collection of values returned by getDatabasePostgresqlConfig.
type GetDatabasePostgresqlConfigResultOutput struct{ *pulumi.OutputState }

func (GetDatabasePostgresqlConfigResultOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetDatabasePostgresqlConfigResult)(nil)).Elem()
}

func (o GetDatabasePostgresqlConfigResultOutput) ToGetDatabasePostgresqlConfigResultOutput() GetDatabasePostgresqlConfigResultOutput {
	return o
}

func (o GetDatabasePostgresqlConfigResultOutput) ToGetDatabasePostgresqlConfigResultOutputWithContext(ctx context.Context) GetDatabasePostgresqlConfigResultOutput {
	return o
}

func (o GetDatabasePostgresqlConfigResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetDatabasePostgresqlConfigResult) string { return v.Id }).(pulumi.StringOutput)
}

func (o GetDatabasePostgresqlConfigResultOutput) PgStatMonitorEnables() GetDatabasePostgresqlConfigPgStatMonitorEnableArrayOutput {
	return o.ApplyT(func(v GetDatabasePostgresqlConfigResult) []GetDatabasePostgresqlConfigPgStatMonitorEnable {
		return v.PgStatMonitorEnables
	}).(GetDatabasePostgresqlConfigPgStatMonitorEnableArrayOutput)
}

func (o GetDatabasePostgresqlConfigResultOutput) Pglookouts() GetDatabasePostgresqlConfigPglookoutArrayOutput {
	return o.ApplyT(func(v GetDatabasePostgresqlConfigResult) []GetDatabasePostgresqlConfigPglookout { return v.Pglookouts }).(GetDatabasePostgresqlConfigPglookoutArrayOutput)
}

func (o GetDatabasePostgresqlConfigResultOutput) SharedBuffersPercentages() GetDatabasePostgresqlConfigSharedBuffersPercentageArrayOutput {
	return o.ApplyT(func(v GetDatabasePostgresqlConfigResult) []GetDatabasePostgresqlConfigSharedBuffersPercentage {
		return v.SharedBuffersPercentages
	}).(GetDatabasePostgresqlConfigSharedBuffersPercentageArrayOutput)
}

func (o GetDatabasePostgresqlConfigResultOutput) WorkMems() GetDatabasePostgresqlConfigWorkMemArrayOutput {
	return o.ApplyT(func(v GetDatabasePostgresqlConfigResult) []GetDatabasePostgresqlConfigWorkMem { return v.WorkMems }).(GetDatabasePostgresqlConfigWorkMemArrayOutput)
}

func init() {
	pulumi.RegisterOutputType(GetDatabasePostgresqlConfigResultOutput{})
}
