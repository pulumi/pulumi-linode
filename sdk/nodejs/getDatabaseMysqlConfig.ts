 ...
 */
export function getDatabaseMysqlConfig(opts?: pulumi.InvokeOptions): Promise<GetDatabaseMysqlConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("linode:index/getDatabaseMysqlConfig:getDatabaseMysqlConfig", {
    }, opts);
}
 ...
 * * `type` - The type of the value of `waitTimeout`.
 */
export function getDatabaseMysqlConfigOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseMysqlConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("linode:index/getDatabaseMysqlConfig:getDatabaseMysqlConfig", {
    }, opts);
}
