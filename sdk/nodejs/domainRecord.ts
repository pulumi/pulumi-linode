...
export class DomainRecord extends pulumi.CustomResource {
    ...
    /**
     * The name of this Record. This field's actual usage depends on the type of record this represents. For A and AAAA
    ...
    /**
     * The type of Record this is in the DNS system. For example, A records associate a domain name with an IPv4 address,
    ...
    /**
     * The target for this Record. This field's actual usage depends on the type of record this represents. For A and AAAA
    ...
    constructor(name: string, argsOrState?: DomainRecordArgs | DomainRecordState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            const state: DomainRecordState = argsOrState as DomainRecordState | undefined;
