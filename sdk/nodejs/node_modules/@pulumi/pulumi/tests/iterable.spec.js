...
describe("iterable", () => {
    it("toMap does its job", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        const instances = [
            { id: resource_1.Output.create("i-1234"), privateIp: resource_1.Output.create("192.168.1.2") },
            { id: resource_1.Output.create("i-5678"), privateIp: resource_1.Output.create("192.168.1.5") },
        ];
    ...
    it("groupBy does its job", util_1.asyncTest(() => __awaiter(this, void 0, void 0, function* () {
        const instances = [
            { id: resource_1.Output.create("i-1234"), availabilityZone: resource_1.Output.create("us-east-1a") },
            { id: resource_1.Output.create("i-1538"), availabilityZone: resource_1.Output.create("us-west-2c") },
            { id: resource_1.Output.create("i-5678"), availabilityZone: resource_1.Output.create("us-east-1a") },
        ];
