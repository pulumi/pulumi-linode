...
function transferProperties(onto, label, props) {
    ...
    for (const k of Object.keys(props)) {
        ...
        onto[k] = new resource_1.Output(onto, debuggable_1.debuggablePromise(new Promise(resolve => resolveValue = resolve), `transferProperty(${label}, ${k}, ${props[k]})`), debuggable_1.debuggablePromise(new Promise(resolve => resolveIsKnown = resolve), `transferIsStable(${label}, ${k}, ${props[k]})`));
    }
    return resolvers;
}
 ...
 * registerResource.
 */
function serializeFilteredProperties(label, props, acceptKey, propertyDependencies) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const k of Object.keys(props)) {
            if (acceptKey(k)) {
                ...
                const deps = [];
                const v = yield serializeProperty(`${label}.${k}`, props[k], deps);
                if (v !== undefined) {
                    result[k] = v;
 ...
 */
function serializeResourceProperties(label, props, propertyDependencies) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function serializeProperties(label, props, propertyDependencies) {
    return __awaiter(this, void 0, void 0, function* () {
