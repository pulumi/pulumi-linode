    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function serializeWorkerAsync() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (error) {
                    yield throwSerializationErrorAsync(func, context, error);
                }
                ...
                if (proto !== Function.prototype &&
                    !isAsyncFunction &&
                    !(yield isDerivedNoCaptureConstructorAsync(func))) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        for (const name of capturedVariables.keys()) {
                            ...
                            try {
                                ...
                                yield throwSerializationErrorAsync(func, context, err.message);
                            }
...
function throwSerializationErrorAsync(func, context, info) {
    return __awaiter(this, void 0, void 0, function* () {
        let message = "";
        ...
        if (moduleIndex >= 0) {
            ...
            message += "\n";
            if (yield hasTruthyMemberAsync(module.value, "deploymentOnlyModule")) {
...
function getOrCreateEntryAsync(obj, capturedObjectProperties, context, serialize, logInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (obj instanceof Function && (yield hasTruthyMemberAsync(obj, "doNotCapture"))) {
        ...
        function serializeObjectWorkerAsync(localCapturedPropertyChains) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (localCapturedPropertyChains.length === 0) {
                    yield serializeAllObjectPropertiesAsync(environment);
                    return false;
                }
                else {
                    return yield serializeSomeObjectPropertiesAsync(environment, localCapturedPropertyChains);
                }
            });
        }
        ...
        function serializeAllObjectPropertiesAsync(environment) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!entry.object.proto) {
                    ...
                    if (proto !== Object.prototype) {
                        entry.object.proto = yield getOrCreateEntryAsync(proto, undefined, context, serialize, logInfo);
                    }
                }
            });
        }
        ...
        function serializeSomeObjectPropertiesAsync(environment, localCapturedPropertyChains) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        function captureModuleAsync(normalizedModuleName) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if ((yield hasTruthyMemberAsync(obj, "deploymentOnlyModule")) || isLocalModule) {
...
function isDerivedNoCaptureConstructorAsync(func) {
    return __awaiter(this, void 0, void 0, function* () {
        for (let current = func; current; current = Object.getPrototypeOf(current)) {
            if (yield hasTruthyMemberAsync(current, "doNotCapture")) {
                return true;
            }
        }
        return false;
...
function hasTruthyMemberAsync(obj, memberName) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!obj) {
            return false;
        }
