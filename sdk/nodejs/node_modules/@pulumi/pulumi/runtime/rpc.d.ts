 ...
 */
export declare function serializeResourceProperties(label: string, props: Inputs, propertyDependencies: Record<string, Resource[]>): Promise<Record<string, any>>;
/**
 ...
 */
export declare function serializeProperties(label: string, props: Inputs, propertyDependencies: Record<string, Resource[]>): Promise<Record<string, any>>;
/**
