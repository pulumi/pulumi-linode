module github.com/pulumi/pulumi-linode/provider/v4
...
require (
	...
	github.com/linode/linodego/k8s v1.25.1 // indirect
	github.com/linode/terraform-provider-linode/v2 v2.10.1 // indirect
